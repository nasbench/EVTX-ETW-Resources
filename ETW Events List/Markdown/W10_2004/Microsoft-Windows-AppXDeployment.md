...
Microsoft-Windows-AppXDeployment  |  325       |  Microsoft-Windows-AppXDeployment/Operational  |  {PackageFamilyName} is registered in good state, skip re-registering it
Microsoft-Windows-AppXDeployment  |  326       |  Microsoft-Windows-AppXDeployment/Operational  |  Determining packages to be installed during logon for user: {UserSid}.
Microsoft-Windows-AppXDeployment  |  327       |  Microsoft-Windows-AppXDeployment/Operational  |  The following packages will be installed: {InstallPackageList}. The following packages will be removed: {RemovePackageList}
Microsoft-Windows-AppXDeployment  |  328       |  Microsoft-Windows-AppXDeployment/Operational  |  Unable to determine packages to be installed during logon with error: {ErrorCode}.
...
Microsoft-Windows-AppXDeployment  |  1060      |  Microsoft-Windows-AppXDeployment/Diagnostic   |
Microsoft-Windows-AppXDeployment  |  1061      |  Microsoft-Windows-AppXDeployment/Diagnostic   |