...
Microsoft-Windows-AppXDeployment-Server  |  483       |  Microsoft-Windows-AppXDeploymentServer/Operational  |  error {ErrorCode}: Package volume operation {DeploymentOperation} for {PackageName} failed.
...
Microsoft-Windows-AppXDeployment-Server  |  762       |  Microsoft-Windows-AppXDeploymentServer/Operational  |  Windows cannot move this type of package {PackageName}.
...
Microsoft-Windows-AppXDeployment-Server  |  794       |  Microsoft-Windows-AppXDeploymentServer/Operational  |  Windows cannot install package {PackageName} because its does not declare support for an external location.
...
Microsoft-Windows-AppXDeployment-Server  |  799       |  Microsoft-Windows-AppXDeploymentServer/Operational  |  Windows cannot install package {PackageName} because windows.hostRuntime must be in a Main package.
...
Microsoft-Windows-AppXDeployment-Server  |  5605      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  Roaming data status for pacakge {PackageMoniker} is {Error}.
...
Microsoft-Windows-AppXDeployment-Server  |  7003      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  error {ErrorCode} : Cannot register the {PackageFullName} package because the following error was encountered while creating the {Key}\{Subkey} package family registry key: {ErrorText}
Microsoft-Windows-AppXDeployment-Server  |  7004      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  error {ErrorCode}: Cannot register the {PackageFullName} package because the following error was encountered while removing the {Key}\{Subkey} package family registry key: {ErrorText}
...
Microsoft-Windows-AppXDeployment-Server  |  7006      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  error {ErrorCode}: Cannot register the {PackageFullName} package because the following error was encountered while opening the HKEY_CURRENT_USER_LOCAL_SETTINGS registry key: {ErrorText}
Microsoft-Windows-AppXDeployment-Server  |  7007      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  error {ErrorCode}: Cannot register the {PackageFullName} package because the following error was encountered while enumerating to remove the {Key}\{Subkey} package family registry key: {ErrorText}
...
Microsoft-Windows-AppXDeployment-Server  |  7028      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  Removed {PackageMoniker} package from HKEY_CURRENT_USER_LOCAL_SETTINGS families key because it is no longer referenced in the state repository.
...
Microsoft-Windows-AppXDeployment-Server  |  8351      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  error {ErrorCode}: AoW App Evaluate Install failed for package {PackageName}.
Microsoft-Windows-AppXDeployment-Server  |  8352      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  error {ErrorCode}: AoW App Evaluate Update failed for package {PackageName}.
Microsoft-Windows-AppXDeployment-Server  |  8353      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  error {ErrorCode}: AoW App Commit failed for package {PackageName}.
Microsoft-Windows-AppXDeployment-Server  |  8354      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  error {ErrorCode}: AoW App Revert failed with operation {CurrentOperation}.
Microsoft-Windows-AppXDeployment-Server  |  8355      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  error {ErrorCode}: AoW App Uninstall failed for package {PackageName}.
Microsoft-Windows-AppXDeployment-Server  |  8356      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  error {ErrorCode}: AoW App failed to find the element PayloadName in the Manifest for package {PackageName}.
Microsoft-Windows-AppXDeployment-Server  |  8357      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  error {ErrorCode}: AoW App failed to find the element PayloadVersion in the Manifest for package {PackageName}.
...
Microsoft-Windows-AppXDeployment-Server  |  9622      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  {ErrorCode}: PackagedServiceDEH successfully parsed manifests
Microsoft-Windows-AppXDeployment-Server  |  9623      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  {ErrorCode}: PackagedServiceDEH successfully parsed manifests
Microsoft-Windows-AppXDeployment-Server  |  9624      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  {ErrorCode}: PackagedServiceDEH successfully parsed manifests
Microsoft-Windows-AppXDeployment-Server  |  9625      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  {ErrorCode}: PackagedServiceDEH successfully parsed manifests
...
Microsoft-Windows-AppXDeployment-Server  |  10050     |  Microsoft-Windows-AppXDeploymentServer/Operational  |  {FileName}({Line},{Column}) {ErrorCode}: The {PackageName} package cannot be registered because an unexpected error occured while processing the Local Experience Pack extension.
