...
Microsoft-Windows-PowerShell  |  4100      |  Microsoft-Windows-PowerShell/Operational  |  {Payload}Context:{ContextInfo}User Data:{UserData}
Microsoft-Windows-PowerShell  |  4101      |  Microsoft-Windows-PowerShell/Operational  |  {Payload}Context:{ContextInfo}User Data:{UserData}
Microsoft-Windows-PowerShell  |  4102      |  Microsoft-Windows-PowerShell/Operational  |  {Payload}Context:{ContextInfo}User Data:{UserData}
Microsoft-Windows-PowerShell  |  4103      |  Microsoft-Windows-PowerShell/Operational  |  {Payload}Context:{ContextInfo}User Data:{UserData}
Microsoft-Windows-PowerShell  |  4104      |  Microsoft-Windows-PowerShell/Operational  |  Creating Scriptblock text ({MessageNumber} of {MessageTotal}):{ScriptBlockText}ScriptBlock ID: {ScriptBlockId}Path: {Path}
Microsoft-Windows-PowerShell  |  4105      |  Microsoft-Windows-PowerShell/Operational  |  Started invocation of ScriptBlock ID: {ScriptBlockId}Runspace ID: {RunspaceId}
Microsoft-Windows-PowerShell  |  4106      |  Microsoft-Windows-PowerShell/Operational  |  Completed invocation of ScriptBlock ID: {ScriptBlockId}Runspace ID: {RunspaceId}
Microsoft-Windows-PowerShell  |  7937      |  Microsoft-Windows-PowerShell/Analytic     |  {Payload}Context:{ContextInfo}User Data:{UserData}
Microsoft-Windows-PowerShell  |  7938      |  Microsoft-Windows-PowerShell/Analytic     |  {Payload}Context:{ContextInfo}User Data:{UserData}
Microsoft-Windows-PowerShell  |  7939      |  Microsoft-Windows-PowerShell/Analytic     |  {Payload}Context:{ContextInfo}User Data:{UserData}
Microsoft-Windows-PowerShell  |  7940      |  Microsoft-Windows-PowerShell/Analytic     |  {Payload}Context:{ContextInfo}User Data:{UserData}
Microsoft-Windows-PowerShell  |  7941      |  Microsoft-Windows-PowerShell/Analytic     |  Correlating activity id's.  	 CurrentActivityId: {currentActivityId}  	 ParentActivityId: {parentActivityId}
Microsoft-Windows-PowerShell  |  7942      |  Microsoft-Windows-PowerShell/Analytic     |  Class Name = {ClassName}Method Name = {MethodName}Workflow GUID = {WorkflowGuid}Message = {Message}{JobData}Activity Name = {ActivityName}Activity GUID = {ActivityGuid}Parameters = {Parameters}
...
Microsoft-Windows-PowerShell  |  8197      |  Microsoft-Windows-PowerShell/Operational  |  Runspace state changed to {param1}
Microsoft-Windows-PowerShell  |  8198      |  Microsoft-Windows-PowerShell/Operational  |  Attempting session creation retry {param1} for error code {param2} on session Id {param3}
...
Microsoft-Windows-PowerShell  |  24577     |  Microsoft-Windows-PowerShell/Operational  |  Windows PowerShell ISE has started to run script file {FileName}.
...
Microsoft-Windows-PowerShell  |  45083     |  Microsoft-Windows-PowerShell/Analytic     |  Workflow could not be imported from a XAML file because of an error.  	 WorkflowId: {workflowId}  	 ErrorDescription: {errorDescription}
...
Microsoft-Windows-PowerShell  |  45113     |  Microsoft-Windows-PowerShell/Analytic     |  Unloading workflow.  	 WorkflowId: {workflowId}
...
Microsoft-Windows-PowerShell  |  46347     |  Microsoft-Windows-PowerShell/Debug        |  ProxyJob with Guid {ProxyJobInstanceId} associated with remote ContainerParentJob with Guid {ContainerParentJobInstanceId}
