...
Microsoft-Windows-WMI  |  Error        |  10          |  2        |  Application  |        |          |           |  Event filter with query '{Query}' could not be reactivated in namespace '{Namespace}' because of error {Error}. Events cannot be delivered through this filter until the problem is corrected.
