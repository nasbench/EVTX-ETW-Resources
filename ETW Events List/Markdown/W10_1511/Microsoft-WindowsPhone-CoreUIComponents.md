...
Microsoft-WindowsPhone-CoreUIComponents  |  1566      |           |  CoreUI ServerTask (TaskID={unParam1}) - ChangeBounds (width = {unParam2} height = {unParam3}; adjacentDisplayFlags = {unParam4}; applicationViewState = {unParam5}; userInteractionMode = {unParam6}; fullScreenMode = {unParam7})
...
Microsoft-WindowsPhone-CoreUIComponents  |  5006      |           |  Proxy - ConnectExistingProxyInternal (destProcessId={unParam}; destThreadId={unParam2})
...
Microsoft-WindowsPhone-CoreUIComponents  |  8023      |           |  CoreUI SessionLayer (Type={appLayer}) - NavigateToView (TaskID={unParam}; targetState={targetState}; direction={direction}; reason={reason}; applicationId={pwsz})
...
Microsoft-WindowsPhone-CoreUIComponents  |  9506      |           |  ViewActivator - NotifyBrokerActivateModernCompleted (tokenId={unParam}, viewId={unParam2}, result={hex}, recentActivationReason={reason}, applicationId={pwsz})
...
Microsoft-WindowsPhone-CoreUIComponents  |  9509      |           |  ViewActivator - PrepareActivationCleanupList (appUserModelId={pwsz})
...
Microsoft-WindowsPhone-CoreUIComponents  |  9511      |           |  ViewActivator - AddTaskToCleanupMap (taskInstanceId={unParam}, appUserModelId={pwsz})
Microsoft-WindowsPhone-CoreUIComponents  |  9512      |           |  ViewActivator - RemoveTaskFromCleanupMap (taskInstanceId={unParam}, appUserModelId={pwsz})
