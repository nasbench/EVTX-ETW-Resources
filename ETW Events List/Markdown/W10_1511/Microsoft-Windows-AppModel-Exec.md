...
Microsoft-Windows-AppModel-Exec  |  700       |           |  BAM: Added Package: {PackageFullName} UserSid: {UserSid}.
Microsoft-Windows-AppModel-Exec  |  701       |           |  BAM: Removed Package: {PackageFullName} UserSid: {UserSid}.
...
Microsoft-Windows-AppModel-Exec  |  704       |           |  BAM: AccessState Changed for Package: {PackageFullName} OldState: {Old_AccessState} NewState: {New_AccessState} UserSid: {UserSid}.
...
Microsoft-Windows-AppModel-Exec  |  1101      |           |  FM: Registering callback {p1_String} HRESULT={p2_UInt32}
Microsoft-Windows-AppModel-Exec  |  1102      |           |  FM: Vacate Foreground ApplicationLayer={p1_AppLayer} HRESULT={p2_UInt32}
Microsoft-Windows-AppModel-Exec  |  1103      |           |  FM: Generate ActivationInstanceID Id={p1_UInt32}
Microsoft-Windows-AppModel-Exec  |  1104      |           |  FM: +ActivationPrerequisitePhase ActivationInstanceId={p1_UInt32} ApplicationLayer={p2_AppLayer} AUMID={p3_UInt64} ContractId={p4_String}
Microsoft-Windows-AppModel-Exec  |  1105      |           |  FM: -ActivationPrerequisitePhase HRESULT={p1_UInt32} fPending={p2_Boolean}
Microsoft-Windows-AppModel-Exec  |  1106      |           |  FM: +Resume_RehydrationPhase ActivationInstanceId={p1_UInt32}
Microsoft-Windows-AppModel-Exec  |  1107      |           |  FM: -Resume_RehydrationPhase ActivationInstanceId={p1_UInt32} HRESULT={p2_UInt32}
Microsoft-Windows-AppModel-Exec  |  1108      |           |  FM: +PostActivationPhase ActivationInstanceId={p1_UInt32}
Microsoft-Windows-AppModel-Exec  |  1109      |           |  FM: -PostActivationPhase ActivationInstanceId={p1_UInt32} HRESULT={p2_UInt32}
Microsoft-Windows-AppModel-Exec  |  1110      |           |  FM: +ResumeActivation ActivationInstanceId={p1_UInt32} ApplicationLayer={p2_AppLayer} fIsResumed={p3_Boolean}
Microsoft-Windows-AppModel-Exec  |  1111      |           |  FM: -ResumeActivation ActivationInstanceId={p1_UInt32} HRESULT={p2_UInt32}
Microsoft-Windows-AppModel-Exec  |  1112      |           |  FM: +Resume_ActivationPhase ActivationInstanceId={p1_UInt32}
Microsoft-Windows-AppModel-Exec  |  1113      |           |  FM: -Resume_ActivationPhase ActivationInstanceId={p1_UInt32} HRESULT={p2_UInt32}
Microsoft-Windows-AppModel-Exec  |  1114      |           |  FM: +PauseActivation ActivationInstanceId={p1_UInt32}
Microsoft-Windows-AppModel-Exec  |  1115      |           |  FM: -PauseActivation HRESULT={p1_UInt32} PausePending={p2_Boolean}
Microsoft-Windows-AppModel-Exec  |  1116      |           |  FM: +CancelActivation ActivationInstanceId={p1_UInt32}
Microsoft-Windows-AppModel-Exec  |  1117      |           |  FM: -CancelActivation ActivationInstanceId={p1_UInt32} HRESULT={p2_UInt32}
Microsoft-Windows-AppModel-Exec  |  1118      |           |  FM: +AbortActivation ActivationInstanceId={p1_UInt32} Reason={p2_String} fGenerateWER={p3_Boolean}
Microsoft-Windows-AppModel-Exec  |  1119      |           |  FM: -AbortActivation ActivationInstanceId={p1_UInt32} HRESULT={p2_UInt32}
Microsoft-Windows-AppModel-Exec  |  1120      |           |  FM: +GetActivationProcessId ActivationInstanceId={p1_UInt32}
Microsoft-Windows-AppModel-Exec  |  1121      |           |  FM: -GetActivationProcessId ActivationInstanceId={p1_UInt32} PID{p2_UInt32} HRESULT={p3_UInt32}
Microsoft-Windows-AppModel-Exec  |  1122      |           |  FM: +SetForegroundActivationInstance ActivationInstanceId={p1_UInt32} ApplicationLayer={p2_AppLayer} Isforeground={p3_Boolean}
Microsoft-Windows-AppModel-Exec  |  1123      |           |  FM: -SetForegroundActivationInstance ActivationInstanceId={p1_UInt32} HRESULT={p2_UInt32}
Microsoft-Windows-AppModel-Exec  |  1124      |           |  FM: +SetForeground_ActivationPhase ActivationInstanceId={p1_UInt32}
Microsoft-Windows-AppModel-Exec  |  1125      |           |  FM: -SetForeground_ActivationPhase ActivationInstanceId={p1_UInt32} HRESULT={p2_UInt32}
Microsoft-Windows-AppModel-Exec  |  1126      |           |  FM: SetActivationDehydrationEligibility TaskID={p1_UInt32} State={p2_UInt32} HRESULT={p3_UInt32}
Microsoft-Windows-AppModel-Exec  |  1127      |           |  FM: OnActivationStateChanged ActivationInstanceId={ActivationId} state={ActState} HRESULT={HRESULT}
Microsoft-Windows-AppModel-Exec  |  1128      |           |  FM: OnApplicationStateChanged AUMID={ApplicationId} state={AppState} HRESULT={HRESULT}
Microsoft-Windows-AppModel-Exec  |  1129      |           |  FM: IsValidActivationProcessId ActivationInstanceID={p1_UInt32} PID={p2_UInt32} fValid={p3_Boolean} HRESULT={p4_UInt32}
Microsoft-Windows-AppModel-Exec  |  1130      |           |  FM: GetForegroundProductId fIgnoreLockScreen={p1_Boolean} ProductID={p2_GUID} HRESULT={p3_UInt32}
Microsoft-Windows-AppModel-Exec  |  1131      |           |  FM: GetProductIdFromProcessID ProductID={p1_GUID} PID={p2_UInt32} HRESULT={p3_UInt32}
Microsoft-Windows-AppModel-Exec  |  1132      |           |  FM: Discarding Application Frozen notification because the application isn't really frozen
Microsoft-Windows-AppModel-Exec  |  1133      |           |  FM: Dehydrate Application AUMID={p1_UInt64} HRESULT={p2_String}
Microsoft-Windows-AppModel-Exec  |  1134      |           |  FM: +ResumePrerequisitePhase ActivationInstanceId={p1_UInt32} ApplicationLayer={p2_AppLayer}
Microsoft-Windows-AppModel-Exec  |  1135      |           |  FM: -ResumePrerequisitePhase HRESULT={p1_UInt32} fPending={p2_Boolean}
Microsoft-Windows-AppModel-Exec  |  1136      |           |  FM: AcquireForegroundResourceSet ActivationInstanceId={p1_UInt32} AUMID={p2_String} LaunchFlags={p3_UInt32} ResourceSet to acquire={p4_UInt32}
Microsoft-Windows-AppModel-Exec  |  1137      |           |  FM: OnRelease ForegroundResourceSet ActivationInstanceId={p1_UInt32} HRESULT={p2_UInt32}
Microsoft-Windows-AppModel-Exec  |  1138      |           |  FM: GenerateWatsonReport PID={p1_UInt32} Reason={p2_String} HRESULT={p3_UInt32}
Microsoft-Windows-AppModel-Exec  |  1139      |           |  FM: TaskCompletion New Battery Saver State {p1_UInt32}
Microsoft-Windows-AppModel-Exec  |  1140      |           |  FM: TaskCompletion Revoke Exemption PID={p1_UInt32} AUMID={p2_String} TC={p3_UInt32}
Microsoft-Windows-AppModel-Exec  |  1141      |           |  FM: TaskCompletion Apply({p3_Boolean}) Exemption PID={p1_UInt32} TC={p2_UInt32} HRESULT={p4_UInt32}
Microsoft-Windows-AppModel-Exec  |  1142      |           |  FM: SetContinuation ActivationInstanceID={p1_UInt32}
Microsoft-Windows-AppModel-Exec  |  1143      |           |  FM: AbandonContinuation ActivationInstanceID={p1_UInt32} ApplicationLayer={p2_AppLayer}
Microsoft-Windows-AppModel-Exec  |  1144      |           |  FM: PerformContinuation ActivationInstanceID={p1_UInt32} ApplicationLayer={p2_AppLayer}
Microsoft-Windows-AppModel-Exec  |  1145      |           |  FM: Shutdown HRESULT={p1_UInt32}
Microsoft-Windows-AppModel-Exec  |  1146      |           |  FM: +PauseActivation ActivationInstanceId={p1_UInt32} AUMID={p2_String} PackageFullName={p3_String}
Microsoft-Windows-AppModel-Exec  |  1147      |           |  FM: +ActivationBypass ActivationInstanceId={p1_UInt32}
Microsoft-Windows-AppModel-Exec  |  1148      |           |  FM: -ActivationBypass ActivationInstanceId={p1_UInt32} HRESULT={p2_UInt32}
Microsoft-Windows-AppModel-Exec  |  1149      |           |  FM: +PostPausePendingResume ActivationInstanceId={p1_UInt32}
Microsoft-Windows-AppModel-Exec  |  1150      |           |  FM: -PostPausePendingResume ActivationInstanceId={p1_UInt32} HRESULT={p2_UInt32}
Microsoft-Windows-AppModel-Exec  |  1151      |           |  FM-ARP: ApplyResourceSet ResourceSet={pResSet} HRESULT={p1_UInt32}
Microsoft-Windows-AppModel-Exec  |  1152      |           |  FM-ARP: ApplyResourceSetType ResourceSetType={p1_UInt32} User={p2_UInt64} PSMKey={p3_String} ResourceSet={pResSet} HRESULT={p4_UInt32}
Microsoft-Windows-AppModel-Exec  |  1153      |           |  FM-ARP: ApplyTerminal ResourceSet={pResSet} HRESULT={p1_UInt32}
Microsoft-Windows-AppModel-Exec  |  1154      |           |  FM-ARP: RemoveInterruptiveUIAccess ResourceSet={pResSet} HRESULT={p1_UInt32}
Microsoft-Windows-AppModel-Exec  |  1155      |           |  FM-ARP: ResetInterruptiveUIAccess ResourceSet={pResSet} HRESULT={p1_UInt32}
Microsoft-Windows-AppModel-Exec  |  1156      |           |  FM-ARP: OnRelease CallbackId={p1_UInt32} HRESULT={p2_UInt32}
Microsoft-Windows-AppModel-Exec  |  1157      |           |  FM-ARP: OnOutOfMemory CallbackId={p1_UInt32} HRESULT={p2_UInt32}
Microsoft-Windows-AppModel-Exec  |  1158      |           |  FM-EEP: CheckProcessBackgroundEligibility ProcessId={p1_UInt32} TaskCompletionCategory={p2_UInt32} HRESULT={p3_UInt32}
Microsoft-Windows-AppModel-Exec  |  1159      |           |  FM-EEP: ApplyTaskCompletion ProcessId={p1_UInt32} TaskCompletionCategory={p2_UInt32} HRESULT={p3_UInt32}
Microsoft-Windows-AppModel-Exec  |  1160      |           |  FM-EEP: RevokeTaskCompletion ProcessId={p1_UInt32} TaskCompletionCategory={p2_UInt32} HRESULT={p3_UInt32}
Microsoft-Windows-AppModel-Exec  |  1161      |           |  FM-EEP: RequestExtendedExecution ProcessId={p1_UInt32} Reason={p2_UInt32} HRESULT={p3_UInt32}
Microsoft-Windows-AppModel-Exec  |  1162      |           |  FM-EEP: RegisterForExtensionRevokedEvent ProcessId={p1_UInt32} HRESULT={p2_UInt32}
Microsoft-Windows-AppModel-Exec  |  1163      |           |  FM-EEP: CompleteExtendedExecution ProcessId={p1_UInt32} fIsResumed={p2_Boolean} HRESULT={p3_UInt32}
Microsoft-Windows-AppModel-Exec  |  1164      |           |  FM-EEP: RevokeSuspensionExtension User={p1_UInt64} PsmKey={p2_String} HRESULT={p3_UInt32}
Microsoft-Windows-AppModel-Exec  |  1165      |           |  FM-ARP: NotifyPendingResourceSetTransition ResourceSetType={p1_UInt32} ResourceSet={pResSet} HRESULT={p3_UInt32}
Microsoft-Windows-AppModel-Exec  |  1166      |           |  FM-EEP: ApplyTaskCompletionResourceSet AppUserModelId={p0} fTimerExpiredCallback={p1} HRESULT={p2}
Microsoft-Windows-AppModel-Exec  |  1167      |           |  FM-EEP: IsApplicationStateBackgroundEligibile User={p0} PsmKey={p1} fResult={p2}
Microsoft-Windows-AppModel-Exec  |  1168      |           |  FM-EEP: RevokeTaskCompletionExemption AppUserModelId={p1_String} HRESULT={p2_UInt32}
Microsoft-Windows-AppModel-Exec  |  1169      |           |  FM-EEP: AllowBackgroundExecution User={p1_UInt64} AppUserModelId={p2_String} HRESULT={p3_UInt32}
Microsoft-Windows-AppModel-Exec  |  1170      |           |  FM-EEP: OnPackageEnergyStateChange PackageFullName={p1_String} PackageState={p2_UInt32} HRESULT={p3_UInt32}
Microsoft-Windows-AppModel-Exec  |  1171      |           |  FM: SetActivationImportanceVector TaskID={p1_UInt32} Vector={p2_UInt32} HRESULT={p3_UInt32}
Microsoft-Windows-AppModel-Exec  |  1172      |           |  FM: NotifyWindowAdded TaskID={p1_UInt32} WindowInstanceId={p2_UInt32} HRESULT={p3_UInt32}
Microsoft-Windows-AppModel-Exec  |  1173      |           |  FM: NotifyWindowRemoved TaskID={p1_UInt32} WindowInstanceId={p2_UInt32} HRESULT={p3_UInt32}
Microsoft-Windows-AppModel-Exec  |  1174      |           |  FTM: Logoff User={p1_UInt64} HRESULT={p2_UInt32}
Microsoft-Windows-AppModel-Exec  |  1175      |           |  FM-EEP: UnregisterForExtensionRevokedEvent ProcessId={p1_UInt32} HRESULT={p2_UInt32}
Microsoft-Windows-AppModel-Exec  |  1176      |           |  FM-EEP: RegisterExtendedExecutionClient ProcessId={p1_UInt32} HRESULT={p2_UInt32}
Microsoft-Windows-AppModel-Exec  |  1177      |           |  FM-EEP: UnregisterExtendedExecutionClient ProcessId={p1_UInt32} HRESULT={p2_UInt32}
Microsoft-Windows-AppModel-Exec  |  1178      |           |  FM: ActivationTimeoutPolicyChanged  TaskID={p1_UInt32} WindowInstanceId={p2_UInt32} HRESULT={p3_UInt32}
Microsoft-Windows-AppModel-Exec  |  1179      |           |  FM-EEP: OnConnectedStandbyStateChanged  State={p1_UInt32}
Microsoft-Windows-AppModel-Exec  |  1180      |           |  FM-ARP: ApplyResourceBoost User={p1_UInt64} PsmKey={p2_String} HRESULT={p3_UInt32}
Microsoft-Windows-AppModel-Exec  |  1181      |           |  FM: OnAcquired ForegroundResourceSet ActivationInstanceId={p1_UInt32} HRESULT={p2_UInt32}
Microsoft-Windows-AppModel-Exec  |  1182      |           |  FM-CAM: OnApplicationStateChangedEx UserContext={Usercontext} PsmKey={ApplicationId} state={AppState} HRESULT={HRESULT}
Microsoft-Windows-AppModel-Exec  |  1183      |           |  FM-CAM: AcquireForegroundResource UserContext={p1_UInt64} PsmKey={p2_String} isPending={p3_Boolean} CallbackId={p4_UInt32}
Microsoft-Windows-AppModel-Exec  |  1184      |           |  FM-CAM: OnAcquired CallbackId={p1_UInt32} HRESULT={p2_UInt32}
Microsoft-Windows-AppModel-Exec  |  1185      |           |  FM-CAM: OnRelease CallbackId={p1_UInt32}
Microsoft-Windows-AppModel-Exec  |  1186      |           |  FM-CAM: OnTimerExpired CallbackId={p1_UInt32}
Microsoft-Windows-AppModel-Exec  |  1187      |           |  FM: SendActivationNotification ActivationId={p1_UInt32} NotificationId={p2_UInt32}
...
Microsoft-Windows-AppModel-Exec  |  3554      |           |  FTM: Edp keys locked state ({p1_Boolean})
...
Microsoft-Windows-AppModel-Exec  |  3692      |           |  VoIP: Set Network Active for PDC
Microsoft-Windows-AppModel-Exec  |  3693      |           |  VoIP: Set Network Inactive for PDC
