...
Microsoft-Windows-WLAN-AutoConfig  |  4003      |  System                                         |  WLAN AutoConfig detected limit connectivity, performing Reset/Recover.adapter. Code: {ErrorCode} {Reason} {IpFamily}
