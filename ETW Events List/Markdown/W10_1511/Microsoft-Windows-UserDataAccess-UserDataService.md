...
Microsoft-Windows-UserDataAccess-UserDataService  |  306       |           |  Client does not have the following capbility [{Prop_Type}]
Microsoft-Windows-UserDataAccess-UserDataService  |  307       |           |  Client does not have the following privacy capability [{Prop_Type}]
...
Microsoft-Windows-UserDataAccess-UserDataService  |  709       |           |  Notifying messaging app: PFN = {AppPackageFamilyName}, actions = {NotificationActions}
Microsoft-Windows-UserDataAccess-UserDataService  |  710       |           |
...
Microsoft-Windows-UserDataAccess-UserDataService  |  734       |           |  Notifying filter app: PFN = {AppPackageFamilyName}
