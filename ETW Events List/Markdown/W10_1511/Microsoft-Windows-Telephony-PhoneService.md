...
Microsoft-Windows-Telephony-PhoneService  |  752       |           |  CallProgress - Determined sound configuration according to country code, [LineId={lineId}][CountryCode={homeMcc}][EventSndBusy={eventSndBusy}][EventSndRingback={eventSndRingback}]
