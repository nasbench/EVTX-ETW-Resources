...
-----------------------|------------|-------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Microsoft-Windows-DSC  |  4097      |  Microsoft-Windows-DSC/Operational  |  Job {JobId} : This event indicates that failure happens when {ComponentName} is processing the configuration. Error Id is {ErrorId}. Error Detail is {ErrorDetail}. Resource Id is {ResourceId} and Source Info is {SourceInfo}. Error Message is {ErrorMessage}.
Microsoft-Windows-DSC  |  4098      |  Microsoft-Windows-DSC/Analytic     |  Job {JobId} : Displaying messages from built-in DSC resources:	 WMI channel {WMIMessageChannel} 	 ResourceID: {ResourceId} 	 Message : {MessageBody}
Microsoft-Windows-DSC  |  4099      |  Microsoft-Windows-DSC/Debug        |  Job {JobId} : Method {MethodName} started.
Microsoft-Windows-DSC  |  4100      |  Microsoft-Windows-DSC/Analytic     |  Job {JobId} : Displaying messages from the engine:	 WMI channel {WMIMessageChannel} 	 ResourceID: {ResourceId} 	 Message : {MessageBody}
Microsoft-Windows-DSC  |  4101      |  Microsoft-Windows-DSC/Analytic     |  Job {JobId} : From {ClassName}, message is {MessageBody}
Microsoft-Windows-DSC  |  4102      |  Microsoft-Windows-DSC/Operational  |  Job {JobId} : Operation {Operation} started by user sid {UserSid} from computer {ComputerName}.
Microsoft-Windows-DSC  |  4103      |  Microsoft-Windows-DSC/Operational  |  Job {JobId} : This event indicates that a non-terminating error was thrown when {ComponentName} was executing {OperationCmd} on {ProviderName} DSC resource. FullyQualifiedErrorId is {FullyQualifiedErrorId}. Error Message is {ErrorMessage}.
Microsoft-Windows-DSC  |  4104      |  Microsoft-Windows-DSC/Operational  |  Job {JobId} : This event indicates that failure happens when {ComponentName} is trying to get the configuration from pull server using download manager {DownloadManagerName}. ErrorId is {ErrorId}. ErrorDetail is {ErrorDetail}
Microsoft-Windows-DSC  |  4105      |  Microsoft-Windows-DSC/Operational  |  Job {JobId} : Attempting to get the configuration from pull server using Download Manager {DownloadManagerName}.Configuration Id is {ConfigurationId}.
Microsoft-Windows-DSC  |  4106      |  Microsoft-Windows-DSC/Operational  |  Job {JobId} : Attempting to get the modules from pull server using Download Manager {DownloadManagerName}. Configuration Id is {ConfigurationId}. Modules are {Modules}.
Microsoft-Windows-DSC  |  4107      |  Microsoft-Windows-DSC/Operational  |  Job {JobId} : Attempting to get the action from pull server using Download Manager {DownloadManagerName}. Configuration Id is {ConfigurationId}. Checksum is {Checksum}. Compliance status is {Compliant}.
Microsoft-Windows-DSC  |  4108      |  Microsoft-Windows-DSC/Operational  |  Job {JobId} : Successfully got the configuration from pull server using Download Manager {DownloadManagerName}.
Microsoft-Windows-DSC  |  4109      |  Microsoft-Windows-DSC/Operational  |  Job {JobId} : Successfully got the modules from pull server using Download Manager {DownloadManagerName}.
Microsoft-Windows-DSC  |  4110      |  Microsoft-Windows-DSC/Operational  |  Job {JobId} : Successfully got the action {ActionStatus} from pull server using Download Manager {DownloadManagerName}.
Microsoft-Windows-DSC  |  4111      |  Microsoft-Windows-DSC/Operational  |  Job {JobId} : Successfully installed the certificate {Thumbprint} from {Path}.
Microsoft-Windows-DSC  |  4112      |  Microsoft-Windows-DSC/Operational  |  Job {JobId} : Skipping installing certificate {Thumbprint} as it is already installed.
Microsoft-Windows-DSC  |  4113      |  Microsoft-Windows-DSC/Operational  |  Job {JobId} : Successfully deleted certificate file {Path}.
Microsoft-Windows-DSC  |  4114      |  Microsoft-Windows-DSC/Operational  |  Job {JobId} : Running consistency engine.
Microsoft-Windows-DSC  |  4115      |  Microsoft-Windows-DSC/Operational  |  Job {JobId} : Consistency engine was run successfully.
Microsoft-Windows-DSC  |  4116      |  Microsoft-Windows-DSC/Operational  |  Job {JobId} : This event indicates that failure happened while trying to run consistency engine. ErrorId is {ErrorId}. ErrorDetail is {ErrorDetail}
Microsoft-Windows-DSC  |  4117      |  Microsoft-Windows-DSC/Analytic     |  Job {JobId} : Displaying verbose messages from Powershell DSC resource:	 ResourceID : {ResourceId} 	 Message : {MessageBody}
Microsoft-Windows-DSC  |  4118      |  Microsoft-Windows-DSC/Debug        |  Job {JobId} : Displaying debug messages from Powershell DSC resource:	 ResourceID : {ResourceId} 	 Message : {MessageBody}
Microsoft-Windows-DSC  |  4119      |  Microsoft-Windows-DSC/Debug        |  Job {JobId} : Method {MethodName} started with parameters  	 Class name: {ClassName}  	 Resource ID: {ResourceID}  	 Flags: {Flags}  	 Execution Mode: {ExecutionMode}  	 DSC resource Namespace: {ProviderNamespace}
...
Microsoft-Windows-DSC  |  4168      |  Microsoft-Windows-DSC/Debug        |  Job {JobId} : Function {FunctionName} started with parameters  	 Class name: {ClassName}  	 Method Name: {MethodName}  	 Namespace: {Namespace}
...
Microsoft-Windows-DSC  |  4215      |  Microsoft-Windows-DSC/Operational  |  Job {JobId} : Extraction for module {param1} failed since module path {param2} already exists.
...
Microsoft-Windows-DSC  |  4604      |  Microsoft-Windows-DSC/Operational  |  Job {JobId} : Rotate-DscAgent command for AgentId {AgentId} succeeded.
