...
--------------------------------------|------------|---------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Microsoft-Windows-WPD-MTPClassDriver  |  1000      |  Operational  |
Microsoft-Windows-WPD-MTPClassDriver  |  1001      |  Operational  |  Device will enter the suspend state if idle for {Seconds} seconds.
Microsoft-Windows-WPD-MTPClassDriver  |  1002      |  Operational  |  Device is entering the idle state (Idle state: {State}; Return code: {hr}).
Microsoft-Windows-WPD-MTPClassDriver  |  1003      |  Operational  |  Device is resuming operation from idle state (Idle state: {State}; Return code: {hr}).
Microsoft-Windows-WPD-MTPClassDriver  |  1004      |  Operational  |  Driver has cancelled the operation {Code}
Microsoft-Windows-WPD-MTPClassDriver  |  1005      |  Operational  |  Customizing for '{Manufacturer}, {Model}, {Version}' ({HackModel}).
Microsoft-Windows-WPD-MTPClassDriver  |  1006      |  Operational  |  Driver has failed to start, HRESULT {hr}.
Microsoft-Windows-WPD-MTPClassDriver  |  1007      |  Operational  |  Device has failed to respond to the operation {Code} in 5 minutes, attempted to cancel the operationm HRESULT {hr}.
Microsoft-Windows-WPD-MTPClassDriver  |  1008      |  Operational  |  Device has failed to communicate its status when processing operation {Code}.
Microsoft-Windows-WPD-MTPClassDriver  |  1009      |  Operational  |  Bluetooth transport driver has detected a data discontinuity error: (expected sequence ID {ExpectedValue}, but recevied {ActualValue}).
Microsoft-Windows-WPD-MTPClassDriver  |  1010      |  Operational  |  Bluetooth transport driver has detected a data integrity error in a bulk data transfer operation: (expected CRC-32 value {ExpectedValue}, but received {ActualValue}).
Microsoft-Windows-WPD-MTPClassDriver  |  1011      |  Operational  |  Error in ServicePropList Dataset: Service ID {Code}, Property ID {Prop}, DataSet Offset {Offset}
Microsoft-Windows-WPD-MTPClassDriver  |  1012      |  Operational  |
Microsoft-Windows-WPD-MTPClassDriver  |  1013      |  Operational  |
Microsoft-Windows-WPD-MTPClassDriver  |  1014      |  Operational  |
Microsoft-Windows-WPD-MTPClassDriver  |  1015      |  Operational  |  Error in ObjectPropDesc Dataset: Format ID {Code}, Property ID {Prop}, DataSet Offset {Offset}
Microsoft-Windows-WPD-MTPClassDriver  |  1016      |  Operational  |  Error in InterdependentPropDesc Dataset: Format ID {Code}, DataSet Offset {Offset}
Microsoft-Windows-WPD-MTPClassDriver  |  1017      |  Operational  |  Error in ServiceCapabilities Dataset: Service ID {Code}, Format ID {Prop}, DataSet Offset {Offset}
Microsoft-Windows-WPD-MTPClassDriver  |  1018      |  Operational  |
Microsoft-Windows-WPD-MTPClassDriver  |  1019      |  Operational  |
Microsoft-Windows-WPD-MTPClassDriver  |  1020      |  Operational  |
Microsoft-Windows-WPD-MTPClassDriver  |  1021      |  Operational  |
Microsoft-Windows-WPD-MTPClassDriver  |  1022      |  Operational  |  Error in DeviceInfo Dataset: DataSet Offset {Offset}
Microsoft-Windows-WPD-MTPClassDriver  |  1023      |  Operational  |  Error in StorageInfo Dataset: Storage ID {ID}, DataSet Offset {Offset}
Microsoft-Windows-WPD-MTPClassDriver  |  1024      |  Operational  |  Error in ServiceInfo Dataset: Service ID {ID}, DataSet Offset {Offset}
Microsoft-Windows-WPD-MTPClassDriver  |  1025      |  Operational  |  Error in ObjectInfo Dataset: Object ID {ID}, DataSet Offset {Offset}
Microsoft-Windows-WPD-MTPClassDriver  |  1026      |  Operational  |  Error in DevicePropDesc Dataset: Property ID {ID}, DataSet Offset {Offset}
Microsoft-Windows-WPD-MTPClassDriver  |  1027      |  Operational  |
Microsoft-Windows-WPD-MTPClassDriver  |  1028      |  Operational  |  Unable to parse value for MTP DataType {Code}
Microsoft-Windows-WPD-MTPClassDriver  |  1029      |  Operational  |  Error in ServiceIDs: declared {Expected} elements, but only space to hold {Actual} elements
Microsoft-Windows-WPD-MTPClassDriver  |  1030      |  Operational  |  Warning in ServiceIDs: declared {Expected} elements, but space to hold {Actual} elements
Microsoft-Windows-WPD-MTPClassDriver  |  1031      |  Operational  |  Error in ServiceIDs: count of {Offset} exceeds system limits
Microsoft-Windows-WPD-MTPClassDriver  |  1032      |  Operational  |  Error in StorageIDs: declared {Expected} elements, but only space to hold {Actual} elements
Microsoft-Windows-WPD-MTPClassDriver  |  1033      |  Operational  |  Warning in StorageIDs: declared {Expected} elements, but space to hold {Actual} elements
...
Microsoft-Windows-WPD-MTPClassDriver  |  1067      |  Operational  |  Error in GetObjectPropsSupported Dataset: DataSet Offset {Offset}
