...
Microsoft-Windows-AppXDeployment-Server  |  7105      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  {FileName}({LineNumber},{ColumnNumber}): error {ErrorCode}: Cannot register the {PackageName} package because a custom background task host cannot be specified for this background task type.
Microsoft-Windows-AppXDeployment-Server  |  7106      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  {FileName}({LineNumber},{ColumnNumber}): error {ErrorCode}: Cannot register the {PackageName} package because a task of this type requires a custom background task host.
