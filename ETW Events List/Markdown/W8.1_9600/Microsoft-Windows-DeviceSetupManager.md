...
Microsoft-Windows-DeviceSetupManager  |  131       |  Microsoft-Windows-DeviceSetupManager/Admin        |  Metadata staging failed, result={Prop_ContainerId} for container '{HRESULT}'
