...
----------------------------------------------|------------|---------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Microsoft-Windows-ServerManager-MultiMachine  |  0         |  Operational  |
Microsoft-Windows-ServerManager-MultiMachine  |  1         |  Operational  |
Microsoft-Windows-ServerManager-MultiMachine  |  2         |  Debug        |  Start of filtering out in-progress refresh.
Microsoft-Windows-ServerManager-MultiMachine  |  3         |  Debug        |  End of filtering out in-progress refresh.
Microsoft-Windows-ServerManager-MultiMachine  |  4         |  Operational  |
Microsoft-Windows-ServerManager-MultiMachine  |  5         |  Operational  |  Start of triggering refresh job. Server: {MachineName}. Job: {JobName}.
Microsoft-Windows-ServerManager-MultiMachine  |  6         |  Operational  |  End of triggering refresh job. Server: {MachineName}. Job: {JobName}.
Microsoft-Windows-ServerManager-MultiMachine  |  7         |  Operational  |  Error received from refresh job.
Microsoft-Windows-ServerManager-MultiMachine  |  8         |  Operational  |  Child job completed. Command: {Command}, Target: {Target}, State: {State}, Proxy Instance ID: {ID}
Microsoft-Windows-ServerManager-MultiMachine  |  9         |  Operational  |  Parent job completed. Command: {Command}, Target: {Target}, State: {State}, Proxy Instance ID: {ID}
Microsoft-Windows-ServerManager-MultiMachine  |  10        |  Operational  |  Start of request for refresh. Source: {RefreshTriggerSource}. Categories: {Category}. Servers: {Machines}. Session: {ID}
Microsoft-Windows-ServerManager-MultiMachine  |  11        |  Operational  |  End of request for refresh. Source: {RefreshTriggerSource}. Categories: {Category}. Servers: {Machines}. Session: {ID}
Microsoft-Windows-ServerManager-MultiMachine  |  12        |  Debug        |  Task '{TaskName}' execution started.
Microsoft-Windows-ServerManager-MultiMachine  |  13        |  Debug        |  Task '{TaskName}' execution completed.
Microsoft-Windows-ServerManager-MultiMachine  |  14        |  Operational  |  Error during processing data.
Microsoft-Windows-ServerManager-MultiMachine  |  15        |  Debug        |
Microsoft-Windows-ServerManager-MultiMachine  |  16        |  Debug        |
Microsoft-Windows-ServerManager-MultiMachine  |  17        |  Operational  |  Error during decoding of BPA results.
Microsoft-Windows-ServerManager-MultiMachine  |  18        |  Debug        |
Microsoft-Windows-ServerManager-MultiMachine  |  19        |  Debug        |
Microsoft-Windows-ServerManager-MultiMachine  |  20        |  Debug        |
Microsoft-Windows-ServerManager-MultiMachine  |  21        |  Operational  |  Error during updating of Bpa result records.
Microsoft-Windows-ServerManager-MultiMachine  |  22        |  Debug        |  Triggered Bpa results updated event.
Microsoft-Windows-ServerManager-MultiMachine  |  23        |  Debug        |
Microsoft-Windows-ServerManager-MultiMachine  |  24        |  Debug        |
Microsoft-Windows-ServerManager-MultiMachine  |  25        |  Operational  |  Error during decoding of service statuses.
Microsoft-Windows-ServerManager-MultiMachine  |  26        |  Debug        |
Microsoft-Windows-ServerManager-MultiMachine  |  27        |  Debug        |
Microsoft-Windows-ServerManager-MultiMachine  |  28        |  Debug        |
Microsoft-Windows-ServerManager-MultiMachine  |  29        |  Operational  |  Error during updating of services records.
Microsoft-Windows-ServerManager-MultiMachine  |  30        |  Debug        |  Triggered services updated event.
Microsoft-Windows-ServerManager-MultiMachine  |  31        |  Operational  |  Plugin load started for Role Id {roleId}.
Microsoft-Windows-ServerManager-MultiMachine  |  32        |  Operational  |  Plugin load stopped for Role Id {roleId}.
Microsoft-Windows-ServerManager-MultiMachine  |  33        |  Operational  |  Plugin load failed for Role Id {roleId}. {Message}
Microsoft-Windows-ServerManager-MultiMachine  |  34        |  Operational  |  Plugin unload started for Role Id {roleId}.
Microsoft-Windows-ServerManager-MultiMachine  |  35        |  Operational  |  Plugin unload stopped for Role Id {roleId}.
...
Microsoft-Windows-ServerManager-MultiMachine  |  77        |  Operational  |  Triggered performance counter sample data results updated event.
...
Microsoft-Windows-ServerManager-MultiMachine  |  118       |  Operational  |  Failed to close the post deployment configuration task. {Task}, Stack: {Error}
...
Microsoft-Windows-ServerManager-MultiMachine  |  162       |  Operational  |  File mapping initialization failed. {errorCode}
...
Microsoft-Windows-ServerManager-MultiMachine  |  205       |  Debug        |  Refresh item enumeration started. Server: {MachineName}, Class name: {OperationName}
...
Microsoft-Windows-ServerManager-MultiMachine  |  314       |  Debug        |  BPA data processor on next stop. Server name: {serverName}, Parameter name: {parameterName}
...
Microsoft-Windows-ServerManager-MultiMachine  |  346       |  Debug        |  BPA thumbnail view update start. Name: {thumbnailName}, Count: {categories}
...
Microsoft-Windows-ServerManager-MultiMachine  |  2105      |  Operational  |  Deployment configuration data export started. File location: {fileLocation}
...
Microsoft-Windows-ServerManager-MultiMachine  |  9001      |  Operational  |  Get-WindowsFeature cmdlet ended, Guid: {requestGuid}, Components: {serverComponentNames}.
...
Microsoft-Windows-ServerManager-MultiMachine  |  9209      |  Debug        |  GetAlterationState method for Remove-WindowsFeature returned Failed.
