...
Microsoft-Windows-AppXDeployment-Server  |  573       |  Microsoft-Windows-AppXDeploymentServer/Operational  |  Setting Sync Enabled status cache has {RoamingDataStatus}, actual {SettingSyncStatus} (0:API not called, 1:disabled, 2:enabled).
...
Microsoft-Windows-AppXDeployment-Server  |  625       |  Microsoft-Windows-AppXDeploymentServer/Operational  |
Microsoft-Windows-AppXDeployment-Server  |  626       |  Microsoft-Windows-AppXDeploymentServer/Operational  |  Deployment {DeploymentOperation} operation on package {PackageFullName} has been requeued for user {UserDomain}\{UserName}.
...
Microsoft-Windows-AppXDeployment-Server  |  3890      |  Microsoft-Windows-AppXDeploymentServer/Diagnostic   |
Microsoft-Windows-AppXDeployment-Server  |  3891      |  Microsoft-Windows-AppXDeploymentServer/Diagnostic   |
Microsoft-Windows-AppXDeployment-Server  |  3892      |  Microsoft-Windows-AppXDeploymentServer/Diagnostic   |
Microsoft-Windows-AppXDeployment-Server  |  3893      |  Microsoft-Windows-AppXDeploymentServer/Diagnostic   |
Microsoft-Windows-AppXDeployment-Server  |  3894      |  Microsoft-Windows-AppXDeploymentServer/Diagnostic   |
Microsoft-Windows-AppXDeployment-Server  |  3895      |  Microsoft-Windows-AppXDeploymentServer/Diagnostic   |
Microsoft-Windows-AppXDeployment-Server  |  3896      |  Microsoft-Windows-AppXDeploymentServer/Diagnostic   |
Microsoft-Windows-AppXDeployment-Server  |  3897      |  Microsoft-Windows-AppXDeploymentServer/Diagnostic   |
Microsoft-Windows-AppXDeployment-Server  |  3898      |  Microsoft-Windows-AppXDeploymentServer/Diagnostic   |
Microsoft-Windows-AppXDeployment-Server  |  3899      |  Microsoft-Windows-AppXDeploymentServer/Diagnostic   |
...
Microsoft-Windows-AppXDeployment-Server  |  7700      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  {ErrorCode}: Cannot register package {PackageName} because of an error in DeviceCapability {DeviceCapabilityName}: missing required Device element
