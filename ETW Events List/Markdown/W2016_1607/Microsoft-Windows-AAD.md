...
Microsoft-Windows-AAD  |  1024      |  Microsoft-Windows-AAD/Analytic     |  Http request status: {value}
Microsoft-Windows-AAD  |  1025      |  Microsoft-Windows-AAD/Analytic     |  Http request status: {value}. Method: {Method} Endpoint Uri: {EndpointUri} Correlation ID: {CorrelationID}
