...
Microsoft-Windows-AppXDeployment-Server  |  317       |  Microsoft-Windows-AppXDeploymentServer/Operational  |  {FileName}({Line},{Column}): warning: The '{ExtensionName}' extension category in the {PackageName} package is unrecognized.
...
Microsoft-Windows-AppXDeployment-Server  |  445       |  Microsoft-Windows-AppXDeploymentServer/Operational  |  GetFullyQualifiedReference from the File Resource Map for package full name: {PackageFullName} and reference string: {ReferenceString} failed.
...
Microsoft-Windows-AppXDeployment-Server  |  837       |  Microsoft-Windows-AppXDeploymentServer/Operational  |  {PackageName}
...
Microsoft-Windows-AppXDeployment-Server  |  3343      |  Microsoft-Windows-AppXDeploymentServer/Diagnostic   |
...
Microsoft-Windows-AppXDeployment-Server  |  4154      |  Microsoft-Windows-AppXDeploymentServer/Diagnostic   |
Microsoft-Windows-AppXDeployment-Server  |  4155      |  Microsoft-Windows-AppXDeploymentServer/Diagnostic   |
Microsoft-Windows-AppXDeployment-Server  |  4156      |  Microsoft-Windows-AppXDeploymentServer/Diagnostic   |
Microsoft-Windows-AppXDeployment-Server  |  4157      |  Microsoft-Windows-AppXDeploymentServer/Diagnostic   |
Microsoft-Windows-AppXDeployment-Server  |  4158      |  Microsoft-Windows-AppXDeploymentServer/Diagnostic   |
Microsoft-Windows-AppXDeployment-Server  |  4159      |  Microsoft-Windows-AppXDeploymentServer/Diagnostic   |
...
Microsoft-Windows-AppXDeployment-Server  |  5232      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  Error while acquiring roaming mutex. Error Code: {ReturnVal}.
...
Microsoft-Windows-AppXDeployment-Server  |  5412      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  {FileName}({LineNumber},{ColumnNumber}): error {ErrorCode}: The OSMaxVersionTested element must be greater than or equal to the OSMinVersion element for package {PackageName}.
...
Microsoft-Windows-AppXDeployment-Server  |  5504      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  {PackageName} : {FilePath} : {Message}
...
Microsoft-Windows-AppXDeployment-Server  |  5600      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  An internal error occurred with error {ReturnVal}. See http://go.microsoft.com/fwlink/?LinkId=235160 for help diagnosing app deployment issues.
Microsoft-Windows-AppXDeployment-Server  |  5601      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  An internal error occurred with error {ReturnVal}. See http://go.microsoft.com/fwlink/?LinkId=235160 for help diagnosing app deployment issues.
...
Microsoft-Windows-AppXDeployment-Server  |  6400      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  error {ErrorCode}: Failed to install Game {PackageMoniker}.
Microsoft-Windows-AppXDeployment-Server  |  6401      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  error {Error}: Failed to create Internal Game State.
Microsoft-Windows-AppXDeployment-Server  |  6402      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  error {ErrorCode}: Failed to remove Game {PackageMoniker}.
Microsoft-Windows-AppXDeployment-Server  |  6403      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  The extension content from the package manifest is {Message}.
Microsoft-Windows-AppXDeployment-Server  |  6404      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  The game definition file container file path is {Message}.
Microsoft-Windows-AppXDeployment-Server  |  6405      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  error {Error}: game definition file container file not found.
Microsoft-Windows-AppXDeployment-Server  |  6406      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  error {Error}: Failed to validate extension content.
Microsoft-Windows-AppXDeployment-Server  |  6407      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  error {ErrorCode}: Game {PackageMoniker} is already installed.
Microsoft-Windows-AppXDeployment-Server  |  6408      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  error {ErrorCode}: Game {PackageMoniker} is not installed.
Microsoft-Windows-AppXDeployment-Server  |  6409      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  error {Error}: Could not create a GameExplorer object.
Microsoft-Windows-AppXDeployment-Server  |  6410      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  error {Error}: Failed to validate input parameters.
Microsoft-Windows-AppXDeployment-Server  |  6411      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  error {Error}: Internal state not set.
Microsoft-Windows-AppXDeployment-Server  |  6412      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  error {Error}: Invalid Access. This game cannot be installed for the user.
...
Microsoft-Windows-AppXDeployment-Server  |  7800      |  Microsoft-Windows-AppXDeploymentServer/Debug        |  AppSync DEH invoke ({InvokeAction}) on package={PackageFamilyName}.
...
Microsoft-Windows-AppXDeployment-Server  |  7950      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  Geolocation extension could not invoke the Location Framework Service to remove package {PackageName}. A reboot may be needed before re-installing the package (error: {ErrorCode})
...
Microsoft-Windows-AppXDeployment-Server  |  8204      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  Successfully updated volume {VolumeKey} with name "{VolumeName}" mountPoint "{VolumeMountPoint}" and flags {Flags}.
...
Microsoft-Windows-AppXDeployment-Server  |  8206      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  Did not find a matching mediaID for volume {VolumeKey} with name "{VolumeName}" and mountPoint "{VolumeMountPoint}"
...
Microsoft-Windows-AppXDeployment-Server  |  8252      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  {FileName}({LineNumber},{ColumnNumber}): error {ErrorCode}: Cannot register the {PackageName} package because the ServerName attribute cannot be specified for an AppServer extension element.
Microsoft-Windows-AppXDeployment-Server  |  8253      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  {FileName}({LineNumber},{ColumnNumber}): error {ErrorCode}: Cannot register the {PackageName} package because the Executable attribute cannot be specified for an AppServer extension element.
...
Microsoft-Windows-AppXDeployment-Server  |  8562      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  Verify license for {PackageFullName} with error {Error}.
...
Microsoft-Windows-AppXDeployment-Server  |  8722      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  {FileName}({LineNumber},{ColumnNumber}): error {ErrorCode}: Cannot register the {PackageName} package because the extension is missing an EntryPoint or StartPage attribute.
Microsoft-Windows-AppXDeployment-Server  |  8723      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  {FileName}({LineNumber},{ColumnNumber}): error {ErrorCode}: Cannot register the {PackageName} package because the ServerName attribute cannot be specified for an AppServer extension element.
Microsoft-Windows-AppXDeployment-Server  |  8724      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  {FileName}({LineNumber},{ColumnNumber}): error {ErrorCode}: Cannot register the {PackageName} package because the Executable attribute cannot be specified for an AppServer extension element.
...
Microsoft-Windows-AppXDeployment-Server  |  9051      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  IIS Configuration Committed at {IISModuleName}.
...
Microsoft-Windows-AppXDeployment-Server  |  9105      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  {FileName}({Line},{Column}): error {ErrorCode}: Cannot register package {PackageName} . There can only be one extension element with this category.
