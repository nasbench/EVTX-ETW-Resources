...
-----------------------------------------------------|------------|-------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  1         |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Operational  |  Initialization of collection: {collectionName} has started.  Reason: {initializationReason}
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  2         |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Operational  |  The collection named {value} is being reset.
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  3         |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Operational  |  The following selection data was used to choose an initial collection: {layoutSelectionSerializedString}
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  4         |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Operational  |
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  5         |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Operational  |  Initialization of the Start collection has finished in the logon tasks with the following result: {TaskHResultValue}
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  6         |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Operational  |
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  7         |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Operational  |  The collection initialization pipeline got an initial collection from the specified collection provider named: {layoutProviderName}
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  8         |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Operational  |  The collection initialization pipeline got an initial collection from the following provider: {layoutProviderName}
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  9         |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Operational  |
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  10        |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Operational  |
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  11        |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Operational  |  The {layoutProviderName} post processor has succesfully completed its post processing of the initial collection.
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  12        |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Operational  |  The {layoutProviderName} post processor encountered the following error when post processing the initial collection: {HResultValue}
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  13        |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Operational  |
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  14        |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Operational  |
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  15        |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Operational  |  The collection is being written to the {value} data store
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  16        |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Operational  |  The {tileIdentifier} tile was successfully written to storage.
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  17        |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Operational  |  Attempting to write the {tileIdentifier} tile to storage encountered the following error: {failureDetails}
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  18        |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Operational  |  The collection initialization pipeline has finished writing the collection data to permanent storage.
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  19        |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Operational  |  A secondary tile in the chosen layout with the following information is being initialized: {tileData}
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  20        |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Operational  |
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  21        |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Operational  |  The following error occurred while initializing a secondary tile: {failureDetails}
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  22        |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Operational  |  The following error occurred while initializing parsing an xml file: {TaskHResultValue}
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  23        |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Operational  |  The installation of the app for the placeholder tile {tileIdentifier} has been initiated due to tile activation.
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  24        |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Operational  |
...
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  50        |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Operational  |
...
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  1104      |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Operational  |  A tile with identifier:{itemName} and guid:{itemId} was removed from the collection tree parent: {containerId}.
...
Microsoft-Windows-ShellCommon-StartLayoutPopulation  |  2002      |  Microsoft-Windows-ShellCommon-StartLayoutPopulation/Diagnostic   |
