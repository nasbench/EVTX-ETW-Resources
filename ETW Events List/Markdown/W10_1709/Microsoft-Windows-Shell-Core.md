...
Microsoft-Windows-Shell-Core  |  62440     |  Microsoft-Windows-Shell-Core/AppDefaults        |  User choice hash mismatch detected for: {ExtOrUriScheme}. Current prog Id: {ProgId} IsRoaming: {IsRoaming}
Microsoft-Windows-Shell-Core  |  62441     |  Microsoft-Windows-Shell-Core/AppDefaults        |  User choice has been reset to prog id {ProgId} for {ExtOrUriScheme}
...
Microsoft-Windows-Shell-Core  |  62460     |  Microsoft-Windows-Shell-Core/Operational        |  OOBE Health Monitor. Version: {DataVersion}, Health flags: {HealthStateFlags}, Census flags: {CensusFlags}, Seconds since boot: {SecondsSinceBoot}, Detailed info: '{TrackingInfo}'.
