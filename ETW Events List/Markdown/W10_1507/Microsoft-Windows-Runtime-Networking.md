...
--------------------------------------|------------|------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Microsoft-Windows-Runtime-Networking  |  1         |  Microsoft-Windows-Runtime-Networking/Tracing  |  {asyncOperation} at {asyncObject} started.
Microsoft-Windows-Runtime-Networking  |  2         |  Microsoft-Windows-Runtime-Networking/Tracing  |  {asyncOperation} at {asyncObject} failed to start. The error code is {errorCode}: {hresult}
Microsoft-Windows-Runtime-Networking  |  3         |  Microsoft-Windows-Runtime-Networking/Tracing  |  {asyncOperation} at {asyncObject} completed successfully.
Microsoft-Windows-Runtime-Networking  |  4         |  Microsoft-Windows-Runtime-Networking/Tracing  |  {asyncOperation} at {asyncObject} failed with error code {errorCode}: {hresult}.
Microsoft-Windows-Runtime-Networking  |  5         |  Microsoft-Windows-Runtime-Networking/Tracing  |  {asyncOperation} at {asyncObject} was cancelled.
Microsoft-Windows-Runtime-Networking  |  6         |  Microsoft-Windows-Runtime-Networking/Tracing  |  {asyncOperation} at {asyncObject} was closed.
Microsoft-Windows-Runtime-Networking  |  7         |  Microsoft-Windows-Runtime-Networking/Tracing  |  Failed to parse URI '{uri}'.
Microsoft-Windows-Runtime-Networking  |  8         |  Microsoft-Windows-Runtime-Networking/Tracing  |  Failed to create URI with base URI '{str1}' and relative URI '{str2}'.
Microsoft-Windows-Runtime-Networking  |  9         |  Microsoft-Windows-Runtime-Networking/Tracing  |  Add HTTP header '{str1}: {str2}'.
Microsoft-Windows-Runtime-Networking  |  10        |  Microsoft-Windows-Runtime-Networking/Tracing  |  Start connect request to '{str1}' with credential of '{str2}'.
Microsoft-Windows-Runtime-Networking  |  11        |  Microsoft-Windows-Runtime-Networking/Tracing  |  Start connect request to '{uri}' with default credential.
Microsoft-Windows-Runtime-Networking  |  12        |  Microsoft-Windows-Runtime-Networking/Tracing  |  Failed connect request to '{uri}' at port {port}. The last error is {errorCode}: {errorMessage}
Microsoft-Windows-Runtime-Networking  |  13        |  Microsoft-Windows-Runtime-Networking/Tracing  |  Opening request to '{str1}' to '{str2}' with flags {flags}.
Microsoft-Windows-Runtime-Networking  |  14        |  Microsoft-Windows-Runtime-Networking/Tracing  |  Failed open request to '{uri}'. The last error is {port}: {errorCode}
Microsoft-Windows-Runtime-Networking  |  15        |  Microsoft-Windows-Runtime-Networking/Tracing  |  Request context {obj1} has request handle {obj2} to '{uri}'.
Microsoft-Windows-Runtime-Networking  |  16        |  Microsoft-Windows-Runtime-Networking/Tracing  |  Set HTTP send and receive timeout to {length}ms on request handle {obj}.
Microsoft-Windows-Runtime-Networking  |  17        |  Microsoft-Windows-Runtime-Networking/Tracing  |  Start send to request handle {obj} with content length {length}.
Microsoft-Windows-Runtime-Networking  |  18        |  Microsoft-Windows-Runtime-Networking/Tracing  |  Request handle {obj} completed synchronously.
Microsoft-Windows-Runtime-Networking  |  19        |  Microsoft-Windows-Runtime-Networking/Tracing  |  Request context {obj} completed send asynchronously.
Microsoft-Windows-Runtime-Networking  |  20        |  Microsoft-Windows-Runtime-Networking/Tracing  |  Writing {length} bytes to request handle {obj}.
Microsoft-Windows-Runtime-Networking  |  21        |  Microsoft-Windows-Runtime-Networking/Tracing  |  Failed to send entity body to request handle {obj}. The last error is {errorCode}: {errorMessage}
Microsoft-Windows-Runtime-Networking  |  22        |  Microsoft-Windows-Runtime-Networking/Tracing  |  Sent HTTP request at request handle {obj}: {statusDescription}
Microsoft-Windows-Runtime-Networking  |  23        |  Microsoft-Windows-Runtime-Networking/Tracing  |  Start to receive response from request handle {obj}.
Microsoft-Windows-Runtime-Networking  |  24        |  Microsoft-Windows-Runtime-Networking/Tracing  |  Received HTTP response from request handle {obj} with status code {statusCode} and status description '{statusDescription}'.
Microsoft-Windows-Runtime-Networking  |  25        |  Microsoft-Windows-Runtime-Networking/Tracing  |  Receive HTTP response from request handle {obj}: {statusDescription}
Microsoft-Windows-Runtime-Networking  |  26        |  Microsoft-Windows-Runtime-Networking/Tracing  |  Failed to receive HTTP response from request handle {obj}. The last error is {errorCode}: {errorMessage}
Microsoft-Windows-Runtime-Networking  |  27        |  Microsoft-Windows-Runtime-Networking/Tracing  |  Request context {obj} received HTTP response of {length} bytes, which is over the {limit} limit.
Microsoft-Windows-Runtime-Networking  |  28        |  Microsoft-Windows-Runtime-Networking/Tracing  |  Request context {obj} resubmitting the request.
...
Microsoft-Windows-Runtime-Networking  |  57        |  Microsoft-Windows-Runtime-Networking/Tracing  |  WebSocket {obj} is sending the close frame.
