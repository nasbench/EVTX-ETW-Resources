...
Microsoft-Windows-AppModel-MessagingDataModel  |  116       |           |  [IMTransport] Error: Invalid Recipient Contact Type for IM
...
Microsoft-Windows-AppModel-MessagingDataModel  |  1008      |           |  [MessagingCloudServices] CloudServiceSync iteration finished: current iteration = [{Prop_Data1_UInt32}], current iteration successful = [{Prop_Data2_UInt32}]
Microsoft-Windows-AppModel-MessagingDataModel  |  1009      |           |  [MessagingCloudServices] CloudServiceSync sync timer: current iteration = [{Prop_Data1_UInt32}], current iteration successful = [{Prop_Data2_UInt32}], next sync timer interval = [{Prop_Data3_UInt32}]
