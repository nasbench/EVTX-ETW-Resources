...
Microsoft-Windows-PDC  |  19        |  Microsoft-Windows-Kernel-Pdc/Diagnostic  |  Resiliency client {Client}, Port: {Port}, ResiliencyType: {ResiliencyType}, ClientReferences: {References}, Transation Id: {TransactionId}, CurrentState: {CurrentState}, CurrentState: {NextState}
Microsoft-Windows-PDC  |  20        |  Microsoft-Windows-Kernel-Pdc/Diagnostic  |  Message {Message}, TransactionId: {TransactionId}, ClientState: {ClientState}, ClientStatus: {ClientStatus}
Microsoft-Windows-PDC  |  21        |  Microsoft-Windows-Kernel-Pdc/Diagnostic  |  Activator Client {Client} sent a request to PDC
Microsoft-Windows-PDC  |  22        |  Microsoft-Windows-Kernel-Pdc/Diagnostic  |  Response from PDC to activator Client {Client}
