...
Microsoft-Windows-MediaFoundation-Performance  |  4005      |  Media Foundation Performance  |  EVR Dequeue DWM Tag={tag} Object={object} Sample={sample} Original QPC={originalTargetQPC} Target QPC={targetQPC} Submitted QPC={submittedQPC} now={now}  PresentTime={presentTime} Frames Presented={dwmFramesPresented} Refresh Starts={tag}0  Buffers Empty={tag}1 Refresh Frame Count={tag}2
