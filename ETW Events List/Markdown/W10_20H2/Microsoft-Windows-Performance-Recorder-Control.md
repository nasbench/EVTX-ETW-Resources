...
------------------------------------------------|---------------|------------|-----------|-----------|-------------------------------------------|----------|-----------------------|-----------------------------------------------------------------------------------------------------------
Microsoft-Windows-Performance-Recorder-Control  |  Verbose      |  100       |  0        |           |  Perf_ExternalCall                        |  Start   |  Perf Status Verbose  |
Microsoft-Windows-Performance-Recorder-Control  |  Verbose      |  101       |  0        |           |  Perf_ExternalCall                        |  Stop    |  Perf Status Verbose  |
Microsoft-Windows-Performance-Recorder-Control  |  Verbose      |  102       |  0        |           |  Perf_LoadProfileFromFile                 |  Start   |  Perf Status Verbose  |  Loaded profile {ProfileName} from file {FileName}
Microsoft-Windows-Performance-Recorder-Control  |  Verbose      |  103       |  0        |           |  Perf_LoadProfileFromFile                 |  Stop    |  Perf Status Verbose  |
...
Microsoft-Windows-Performance-Recorder-Control  |  Information  |  114       |  0        |           |  Perf_LoadTraceMergePropertiesFromFile    |  Start   |  Perf Status          |  Loaded trace merge properties {TraceMergePropertyName} from file {FileName}
