...
Microsoft-Windows-Hyper-V-Hypervisor  |  10        |  Microsoft-Windows-Hyper-V-Hypervisor-Operational  |  Hypervisor Eventlog creation failed!
Microsoft-Windows-Hyper-V-Hypervisor  |  11        |  Microsoft-Windows-Hyper-V-Hypervisor-Operational  |  Hypervisor Eventlog deletion failed!
Microsoft-Windows-Hyper-V-Hypervisor  |  12        |  Microsoft-Windows-Hyper-V-Hypervisor-Operational  |  Host processor features mask: {ProcessorFeatures}Host xsave features mask: {XsaveFeatures}Host cache line flush size: {CLFlushSize} bytes
Microsoft-Windows-Hyper-V-Hypervisor  |  12        |  Microsoft-Windows-Hyper-V-Hypervisor-Operational  |  Host processor features mask: {ProcessorFeatures}Host xsave features mask: {XsaveFeatures}Host cache line flush size: {CLFlushSize} bytes
...
Microsoft-Windows-Hyper-V-Hypervisor  |  39        |  Microsoft-Windows-Hyper-V-Hypervisor-Admin        |  Hypervisor Load Options - {LoadOptions}.
...
Microsoft-Windows-Hyper-V-Hypervisor  |  156       |  Microsoft-Windows-Hyper-V-Hypervisor-Admin        |  Hypervisor initial page allocation NUMA policy: {InitialAllocationNumaPolicy}
...
Microsoft-Windows-Hyper-V-Hypervisor  |  163       |  Microsoft-Windows-Hyper-V-Hypervisor-Operational  |  The hypervisor encountered an internal error: nested NMI (processor {Processor}).
Microsoft-Windows-Hyper-V-Hypervisor  |  164       |  Microsoft-Windows-Hyper-V-Hypervisor-Operational  |  The hypervisor encountered an internal error: IPI timeout (processor {Processor}).
