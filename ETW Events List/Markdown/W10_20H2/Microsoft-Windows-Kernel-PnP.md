...
------------------------------|------------|-----------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Microsoft-Windows-Kernel-PnP  |  200       |  Boot Diagnostic Channel                |
Microsoft-Windows-Kernel-PnP  |  201       |  Boot Diagnostic Channel                |
Microsoft-Windows-Kernel-PnP  |  202       |  Boot Diagnostic Channel                |
Microsoft-Windows-Kernel-PnP  |  203       |  Boot Diagnostic Channel                |
Microsoft-Windows-Kernel-PnP  |  204       |  Boot Diagnostic Channel                |  OS Loader Start: {OSLoaderStart}OS Loader End: {OSLoaderEnd}
Microsoft-Windows-Kernel-PnP  |  204       |  Boot Diagnostic Channel                |  OS Loader Start: {OSLoaderStart}OS Loader End: {OSLoaderEnd}
Microsoft-Windows-Kernel-PnP  |  204       |  Boot Diagnostic Channel                |  OS Loader Start: {OSLoaderStart}OS Loader End: {OSLoaderEnd}
...
Microsoft-Windows-Kernel-PnP  |  210       |  Driver Diagnostic Channel              |  Begin initializing boot start driver {DriverName}
Microsoft-Windows-Kernel-PnP  |  211       |  Driver Diagnostic Channel              |  End initializing boot start driver {DriverName}.  Status: {Status}
Microsoft-Windows-Kernel-PnP  |  212       |  Driver Diagnostic Channel              |  Begin loading driver {DriverName}
Microsoft-Windows-Kernel-PnP  |  213       |  Driver Diagnostic Channel              |  End loading driver {DriverName}.  Status: {Status}
Microsoft-Windows-Kernel-PnP  |  214       |  Driver Diagnostic Channel              |  Begin unloading driver {DriverName}
Microsoft-Windows-Kernel-PnP  |  215       |  Driver Diagnostic Channel              |  End unloading driver {DriverName}.  Status: {Status}
Microsoft-Windows-Kernel-PnP  |  216       |  Device Enumeration Diagnostic Channel  |  Begin starting device {DriverName}
Microsoft-Windows-Kernel-PnP  |  217       |  Device Enumeration Diagnostic Channel  |  Pending start of device {DriverName}
Microsoft-Windows-Kernel-PnP  |  218       |  Device Enumeration Diagnostic Channel  |  End starting device {DriverName} using driver {FailureName}.  Status: {Status}
Microsoft-Windows-Kernel-PnP  |  219       |  System                                 |  The driver {FailureName} failed to load for the device {DriverName}.
Microsoft-Windows-Kernel-PnP  |  220       |  Device Enumeration Diagnostic Channel  |  Begin querying bus relations for device {DriverName}
Microsoft-Windows-Kernel-PnP  |  221       |  Device Enumeration Diagnostic Channel  |  Pending querying bus relations for device {DriverName}
Microsoft-Windows-Kernel-PnP  |  222       |  Device Enumeration Diagnostic Channel  |  End querying bus relations for device {DriverName}
Microsoft-Windows-Kernel-PnP  |  223       |  Device Enumeration Diagnostic Channel  |  Begin attempting to eject device {DriverName}
Microsoft-Windows-Kernel-PnP  |  224       |  Device Enumeration Diagnostic Channel  |  End attempting to eject device {DriverName}. Status: {Status}
...
Microsoft-Windows-Kernel-PnP  |  226       |  Driver Diagnostic Channel              |  Begin calling driver initialization routine for driver {DriverName}
Microsoft-Windows-Kernel-PnP  |  227       |  Driver Diagnostic Channel              |  End calling driver initialization routine for driver {DriverName}. Status: {Status}
...
Microsoft-Windows-Kernel-PnP  |  907       |  Driver Watchdog Channel                |  A long running thread for device add routine has been completed.Thread ID: {ThreadId}Device: {DeviceInstanceId}Driver: {DriverName}Total run time in milliseconds: {ElapsedTimeMs}
