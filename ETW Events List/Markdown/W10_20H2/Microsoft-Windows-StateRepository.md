...
Microsoft-Windows-StateRepository  |  261       |  Microsoft-Windows-StateRepository/Operational  |  Check repository integrity has been performed [Options={Options}, Disposition={Disposition}, ErrorsDetected={ErrorCount}]
Microsoft-Windows-StateRepository  |  262       |  Microsoft-Windows-StateRepository/Operational  |  Error {ErrorCode}: Check repository integrity encountered an error [Options={Options}, Disposition={Disposition}, ErrorsDetected={ErrorCount}]
Microsoft-Windows-StateRepository  |  263       |  Microsoft-Windows-StateRepository/Operational  |  Fix repository integrity has been performed [Options={Options}, ErrorsCorrected={FixCount}]
Microsoft-Windows-StateRepository  |  264       |  Microsoft-Windows-StateRepository/Operational  |  Error {ErrorCode}: Fix repository integrity encountered an error [Options={Options}, ErrorsCorrected={FixCount}]
...
Microsoft-Windows-StateRepository  |  267       |  Microsoft-Windows-StateRepository/Operational  |  {Count} invalid foreign keys corrected for {Entity}.{Field} [Filename={Filename}]
Microsoft-Windows-StateRepository  |  268       |  Microsoft-Windows-StateRepository/Operational  |  {Count} invalid foreign keys corrected for {Entity}.{Field} [Filename={Filename}]
Microsoft-Windows-StateRepository  |  269       |  Microsoft-Windows-StateRepository/Operational  |  SRCache successfully initialized [Options={Options}]
Microsoft-Windows-StateRepository  |  270       |  Microsoft-Windows-StateRepository/Operational  |  Error {ErrorCode}: SRCache initialization encountered an error [Options={Options}]
Microsoft-Windows-StateRepository  |  271       |  Microsoft-Windows-StateRepository/Operational  |  SRCache successfully updated [Options={Options}]
Microsoft-Windows-StateRepository  |  272       |  Microsoft-Windows-StateRepository/Operational  |  Error {ErrorCode}: SRCache update encountered an error [Options={Options}]
Microsoft-Windows-StateRepository  |  273       |  Microsoft-Windows-StateRepository/Operational  |  Check cache integrity has been performed [Options={Options}, Disposition={Disposition}, ErrorsDetected={ErrorCount}]
Microsoft-Windows-StateRepository  |  274       |  Microsoft-Windows-StateRepository/Operational  |  Error {ErrorCode}: Check cache integrity encountered an error [Options={Options}, Disposition={Disposition}, ErrorsDetected={ErrorCount}]
Microsoft-Windows-StateRepository  |  275       |  Microsoft-Windows-StateRepository/Operational  |  {Count} missing cache entries detected for {Entity} [Ids={Ids}]
Microsoft-Windows-StateRepository  |  276       |  Microsoft-Windows-StateRepository/Operational  |  {Count} unexpected cache entries detected for {Entity} [Ids={Ids}]
Microsoft-Windows-StateRepository  |  277       |  Microsoft-Windows-StateRepository/Operational  |  Invalid cache entry detected for {Entity} [Id={Id}, Fields={Fields}]
