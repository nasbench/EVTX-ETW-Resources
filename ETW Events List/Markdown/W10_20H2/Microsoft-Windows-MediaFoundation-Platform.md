...
Microsoft-Windows-MediaFoundation-Platform  |  101       |  Media Foundation Platform   |  MFShutdown Start
Microsoft-Windows-MediaFoundation-Platform  |  102       |  Media Foundation Platform   |  MFShutdown Stop - return code {hr}
Microsoft-Windows-MediaFoundation-Platform  |  103       |  Media Foundation Platform   |  MFGetConfigurationKey Type {Type} Key {KeyName} Result {lResult}
Microsoft-Windows-MediaFoundation-Platform  |  104       |  Media Foundation Platform   |  MFGetConfigurationValueDWORD Type {Type} Key {KeyName} ValueName {ValueName} Result {lResult} QuerySize {QuerySize} ValueResult {ValueDWORD}
Microsoft-Windows-MediaFoundation-Platform  |  105       |  Media Foundation Platform   |  MFGetConfigurationValueString Type {Type} Key {KeyName} ValueName {ValueName} Result {lResult} QuerySize {QuerySize} ValueResult {ValueString}
