...
------------------------------------|------------|--------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Microsoft-Windows-HelloForBusiness  |  3045      |  Microsoft-Windows-HelloForBusiness/Operational  |  Windows Hello processing started.Scenario type: {HelloScenarioType}
Microsoft-Windows-HelloForBusiness  |  3052      |  Microsoft-Windows-HelloForBusiness/Operational  |
Microsoft-Windows-HelloForBusiness  |  3053      |  Microsoft-Windows-HelloForBusiness/Operational  |
Microsoft-Windows-HelloForBusiness  |  3054      |  Microsoft-Windows-HelloForBusiness/Operational  |
Microsoft-Windows-HelloForBusiness  |  3055      |  Microsoft-Windows-HelloForBusiness/Operational  |
Microsoft-Windows-HelloForBusiness  |  3060      |  Microsoft-Windows-HelloForBusiness/Operational  |  Windows Hello is creating a PIN recovery key for user {UserSid}.
Microsoft-Windows-HelloForBusiness  |  3065      |  Microsoft-Windows-HelloForBusiness/Operational  |  The cloud experience host started.Scenario type: {HelloScenarioType}
Microsoft-Windows-HelloForBusiness  |  3066      |  Microsoft-Windows-HelloForBusiness/Operational  |
Microsoft-Windows-HelloForBusiness  |  3130      |  Microsoft-Windows-HelloForBusiness/Operational  |  Windows Hello PIN Recovery is attempting to change user's PIN. PIN recovery type: {PinRecoveryEntryType}.
Microsoft-Windows-HelloForBusiness  |  3225      |  Microsoft-Windows-HelloForBusiness/Operational  |
Microsoft-Windows-HelloForBusiness  |  3510      |  Microsoft-Windows-HelloForBusiness/Operational  |
Microsoft-Windows-HelloForBusiness  |  3520      |  Microsoft-Windows-HelloForBusiness/Operational  |  Attempting device unlock using provider {DeviceUnlockProvider}. The list of acceptable providers are:Group A: {DeviceUnlockGroupA}Group B: {DeviceUnlockGroupB}
Microsoft-Windows-HelloForBusiness  |  3525      |  Microsoft-Windows-HelloForBusiness/Operational  |
Microsoft-Windows-HelloForBusiness  |  3555      |  Microsoft-Windows-HelloForBusiness/Operational  |
Microsoft-Windows-HelloForBusiness  |  5000      |  Microsoft-Windows-HelloForBusiness/Operational  |  TPM Manufacturer: {Manufacturer}Version: {Version}Status: {Status}
Microsoft-Windows-HelloForBusiness  |  5001      |  Microsoft-Windows-HelloForBusiness/Operational  |  The current user signed in to the computer using {CredentialType}
Microsoft-Windows-HelloForBusiness  |  5050      |  Microsoft-Windows-HelloForBusiness/Operational  |  The key pre-generation pool received a request.Result: {Result}Number of available keys: {NumberOfAvailableKeys}%Elapsed time: {ElapsedTime} seconds
Microsoft-Windows-HelloForBusiness  |  5060      |  Microsoft-Windows-HelloForBusiness/Operational  |  Windows Hello is checking the PIN recovery policy. The policy is {PinRecoveryPolicyState} for user {UserSid}.
Microsoft-Windows-HelloForBusiness  |  5061      |  Microsoft-Windows-HelloForBusiness/Operational  |
Microsoft-Windows-HelloForBusiness  |  5062      |  Microsoft-Windows-HelloForBusiness/Operational  |  Windows Hello found a PIN recovery key for user {UserSid}.
Microsoft-Windows-HelloForBusiness  |  5063      |  Microsoft-Windows-HelloForBusiness/Operational  |  Windows Hello is updating the PIN recovery key for user {UserSid}.
Microsoft-Windows-HelloForBusiness  |  5064      |  Microsoft-Windows-HelloForBusiness/Operational  |
Microsoft-Windows-HelloForBusiness  |  5204      |  Microsoft-Windows-HelloForBusiness/Operational  |  Windows Hello for Business certificate enrollment configurations: Certificate Enrollment Method: {CertificateEnrollmentMethod}Certificate Required for On-Premise Auth: {CertificateRequired}
Microsoft-Windows-HelloForBusiness  |  5225      |  Microsoft-Windows-HelloForBusiness/Operational  |  Creating a {KeyProvider} Windows Hello key with result {Result}.
Microsoft-Windows-HelloForBusiness  |  5520      |  Microsoft-Windows-HelloForBusiness/Operational  |
