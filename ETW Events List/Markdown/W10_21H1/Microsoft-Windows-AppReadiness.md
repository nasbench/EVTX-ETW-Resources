...
Microsoft-Windows-AppReadiness  |  12        |  Admin        |  The Appx preview tile generation failed for user '{User}': {Error}. (Result: {Result})
Microsoft-Windows-AppReadiness  |  100       |  Admin        |
Microsoft-Windows-AppReadiness  |  101       |  Admin        |
Microsoft-Windows-AppReadiness  |  102       |  Debug        |
Microsoft-Windows-AppReadiness  |  103       |  Operational  |
Microsoft-Windows-AppReadiness  |  104       |  Debug        |  App Readiness status changed to '{Status}' (ExitCode: {ExitCode})
...
Microsoft-Windows-AppReadiness  |  110       |  Operational  |  App Readiness service has leaked {ReferencesLeaked} references. This could delay the system shutdown by {ShutdownDelayMsec} milliseconds.
Microsoft-Windows-AppReadiness  |  111       |  Admin        |  App Readiness service failed to DisconnectAll COM Disconnectable Objects. (Result: {Result})
Microsoft-Windows-AppReadiness  |  200       |  Debug        |  Started processing tasks for '{User}'.
Microsoft-Windows-AppReadiness  |  201       |  Debug        |  Finished processing tasks for '{User}'.
Microsoft-Windows-AppReadiness  |  205       |  Debug        |  Loaded queue for '{User}' with {NumPackages} items.
Microsoft-Windows-AppReadiness  |  206       |  Debug        |  '{TaskId}' started for {User}. (Priority: {Priority})
Microsoft-Windows-AppReadiness  |  207       |  Debug        |  '{TaskId}' finished for {User}. (Result: {Result})
...
Microsoft-Windows-AppReadiness  |  212       |  Debug        |  {NumPackages} pre-installed apps found for {SID}
...
Microsoft-Windows-AppReadiness  |  223       |  Debug        |  Shutdown for '{User}' has started.
Microsoft-Windows-AppReadiness  |  224       |  Debug        |  Shutdown for '{User}' has completed.
...
Microsoft-Windows-AppReadiness  |  317       |  Debug        |  Starting pre-registration of '{PackageId}'
...
Microsoft-Windows-AppReadiness  |  5050      |  Debug        |
