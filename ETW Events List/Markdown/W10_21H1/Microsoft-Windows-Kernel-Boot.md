...
Microsoft-Windows-Kernel-Boot  |  183       |  Microsoft-Windows-Kernel-Boot/Operational  |
...
Microsoft-Windows-Kernel-Boot  |  213       |  Microsoft-Windows-Kernel-Boot/Analytic     |  Registry modification detected after load: {PathLength}.
...
Microsoft-Windows-Kernel-Boot  |  231       |  Microsoft-Windows-Kernel-Boot/Operational  |  Boot menu timer canceled due to key press.
Microsoft-Windows-Kernel-Boot  |  232       |                                             |
Microsoft-Windows-Kernel-Boot  |  233       |                                             |
Microsoft-Windows-Kernel-Boot  |  234       |                                             |
Microsoft-Windows-Kernel-Boot  |  235       |  Microsoft-Windows-Kernel-Boot/Operational  |  Windows boot environment failed to initialize TPM device. StatusCode: {StatusCode}, Position: {Position}.
Microsoft-Windows-Kernel-Boot  |  236       |  Microsoft-Windows-Kernel-Boot/Operational  |  SMM isolation level decreased. Reason: {TxtStatus}
Microsoft-Windows-Kernel-Boot  |  237       |  Microsoft-Windows-Kernel-Boot/Operational  |  Hardware memory mirroring is not supported. MirrorStatus: {MirrorStatus}
