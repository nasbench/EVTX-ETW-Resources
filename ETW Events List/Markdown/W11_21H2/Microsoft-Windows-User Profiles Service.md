...
-----------------------------------------|------------|---------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Microsoft-Windows-User Profiles Service  |  1         |               |  Recieved user logon notification on session {Session}.
Microsoft-Windows-User Profiles Service  |  2         |               |  Finished processing user logon notification on session {Session}.
Microsoft-Windows-User Profiles Service  |  3         |               |  Recieved user logoff notification on session {Session}.
Microsoft-Windows-User Profiles Service  |  4         |               |  Finished processing user logoff notification on session {Session}.
Microsoft-Windows-User Profiles Service  |  5         |               |  Registry file {File} is loaded at HKU\{Key}.
Microsoft-Windows-User Profiles Service  |  6         |               |  Starting synchronize profile from {Source} to {Target}.
Microsoft-Windows-User Profiles Service  |  7         |               |  Finished synchronize profile from {Source} to {Target}. Result: {Result}
Microsoft-Windows-User Profiles Service  |  50        |               |  Background hive upload for user {UserSid} started.
Microsoft-Windows-User Profiles Service  |  51        |               |  Background hive upload for user {UserSid} succeeded.
Microsoft-Windows-User Profiles Service  |  52        |               |  Background hive upload for user {UserSid} failed. Error: {Error}
Microsoft-Windows-User Profiles Service  |  53        |               |  Cannot delete file {File}. Error: {Error}
Microsoft-Windows-User Profiles Service  |  54        |               |  Open user regisry root key for {UserSid} failed. Error: {Error}
Microsoft-Windows-User Profiles Service  |  55        |               |  Save user hive to file {File} failed. Error: {Error}
Microsoft-Windows-User Profiles Service  |  56        |               |  Save user hive to file {File} succeeded.
Microsoft-Windows-User Profiles Service  |  57        |               |  Enable background user hive upload task succeeded.
Microsoft-Windows-User Profiles Service  |  58        |               |  Failed to enable background user hive upload task. Error: {Error}
Microsoft-Windows-User Profiles Service  |  59        |               |  Disable background user hive upload task succeeded.
Microsoft-Windows-User Profiles Service  |  60        |               |  Failed to disable background user hive upload task. Error: {Error}
Microsoft-Windows-User Profiles Service  |  61        |               |  Slow network connection detected, abort background user hive upload task.
Microsoft-Windows-User Profiles Service  |  62        |               |  Windows was unable to successfully evaluate whether this computer is a primary computer for this user. This may be due to failing to access the Active Directory server at this time. The user's roaming profile will be applied as configured. Contact the Administrator for more assistance. Error: {Error}
Microsoft-Windows-User Profiles Service  |  63        |               |  This computer {Result} a primary computer for this user.
Microsoft-Windows-User Profiles Service  |  64        |               |  The primary computer relationship for this computer and this user was not evaluated due to {EnvIssue}.
Microsoft-Windows-User Profiles Service  |  65        |               |  The attempt to create or open the profile key for the user failed with error {Error}.
Microsoft-Windows-User Profiles Service  |  66        |               |  Creating the local profile for the user failed with error {Error}.
Microsoft-Windows-User Profiles Service  |  67        |               |  Logon type: {LogonType} Local profile location: {LocalPath} Profile type: {ProfileType}
Microsoft-Windows-User Profiles Service  |  68        |               |  LastDownloadTime: {DownloadTime} LastUploadTime: {UploadTime}
Microsoft-Windows-User Profiles Service  |  70        |               |  Waiting on network arrivals. Max wait time {Timeout} ms.
Microsoft-Windows-User Profiles Service  |  71        |               |  After waiting {Timeout} ms, a network with the necessary capabilities was not ready for use. Allowing profile load to proceed.
Microsoft-Windows-User Profiles Service  |  72        |               |  Terminating wait due to unexpected failure {Result}.
Microsoft-Windows-User Profiles Service  |  73        |               |  Wait complete due to connectivity event but network not ready.
Microsoft-Windows-User Profiles Service  |  74        |               |  Wait completed due to network connectivity or determination that no viable network connection is likely to become available. Allowing profile load to proceed.
Microsoft-Windows-User Profiles Service  |  75        |               |
Microsoft-Windows-User Profiles Service  |  76        |               |
Microsoft-Windows-User Profiles Service  |  1001      |               |
Microsoft-Windows-User Profiles Service  |  1002      |               |
Microsoft-Windows-User Profiles Service  |  1003      |               |  A network latency of {MeasuredLatency} milliseconds has been detected.  Maximum latency to synchronize a roaming profile is set at {LatencyThreshold} milliseconds.
Microsoft-Windows-User Profiles Service  |  1004      |               |  A network bandwidth of {MeasuredBandwidth} kilobits per second has been detected.  Minimum bandwidth to synchronize a roaming profile is set at {BandwidthThreshold} kilobits per second.
Microsoft-Windows-User Profiles Service  |  1005      |               |  Delete cached profile {ProfilePath} since it is older than {AgeLimitInDays} days.
