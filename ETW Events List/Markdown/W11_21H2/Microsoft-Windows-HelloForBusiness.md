...
------------------------------------|------------|-----------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Microsoft-Windows-HelloForBusiness  |  3045      |           |  Windows Hello processing started. Scenario type:{HelloScenarioType}
Microsoft-Windows-HelloForBusiness  |  3052      |           |
Microsoft-Windows-HelloForBusiness  |  3053      |           |
Microsoft-Windows-HelloForBusiness  |  3054      |           |
Microsoft-Windows-HelloForBusiness  |  3055      |           |
Microsoft-Windows-HelloForBusiness  |  3060      |           |  Windows Hello is creating a PIN recovery key for user {UserSid}.
Microsoft-Windows-HelloForBusiness  |  3065      |           |  The Cloud experience host started.Scenario type: {HelloScenarioType}
Microsoft-Windows-HelloForBusiness  |  3066      |           |
Microsoft-Windows-HelloForBusiness  |  3130      |           |  Windows Hello PIN Recovery is attempting to change the user's PIN. PIN recovery type: {PinRecoveryEntryType}.
Microsoft-Windows-HelloForBusiness  |  3225      |           |
Microsoft-Windows-HelloForBusiness  |  3510      |           |
Microsoft-Windows-HelloForBusiness  |  3520      |           |  Attempting device unlock using provider {DeviceUnlockProvider}. The list of acceptable providers are:Group A: {DeviceUnlockGroupA}Group B: {DeviceUnlockGroupB}
Microsoft-Windows-HelloForBusiness  |  3525      |           |
Microsoft-Windows-HelloForBusiness  |  3555      |           |
Microsoft-Windows-HelloForBusiness  |  3601      |           |
Microsoft-Windows-HelloForBusiness  |  3611      |           |
Microsoft-Windows-HelloForBusiness  |  5000      |           |  TPM Manufacturer: {Manufacturer}Version: {Version}Status: {Status}
Microsoft-Windows-HelloForBusiness  |  5001      |           |  The current user signed in to the computer using {CredentialType}
Microsoft-Windows-HelloForBusiness  |  5050      |           |  The key pre-generation pool received a request.Result: {Result}Number of available keys: {NumberOfAvailableKeys}Elapsed time: {ElapsedTime} seconds
Microsoft-Windows-HelloForBusiness  |  5060      |           |  Windows Hello is checking the PIN recovery policy. The policy is {PinRecoveryPolicyState} for user {UserSid}.
Microsoft-Windows-HelloForBusiness  |  5061      |           |
Microsoft-Windows-HelloForBusiness  |  5062      |           |  Windows Hello found a PIN recovery key for user {UserSid}.
Microsoft-Windows-HelloForBusiness  |  5063      |           |  Windows Hello is updating the PIN recovery key for user {UserSid}.
Microsoft-Windows-HelloForBusiness  |  5064      |           |
Microsoft-Windows-HelloForBusiness  |  5204      |           |  Windows Hello for Business certificate enrolment configurations: Certificate Enrolment Method: {CertificateEnrollmentMethod}Certificate Required for On-Premise Auth: {CertificateRequired}
Microsoft-Windows-HelloForBusiness  |  5205      |           |  Windows Hello for Business on-premise authentication configurations: Certificate enrolment method: {CertificateEnrollmentMethod}Certificate required for on-premise auth: {CertificateRequired}Use Cloud Trust for on-premise auth: {UseCloudTrust}Account has cloud TGT: {HasCloudTgt}
Microsoft-Windows-HelloForBusiness  |  5225      |           |  Creating a {KeyProvider} Windows Hello key with result {Result}.
Microsoft-Windows-HelloForBusiness  |  5520      |           |
Microsoft-Windows-HelloForBusiness  |  5555      |           |  Windows Hello is validating that the device can satisfy all applicable policies.TPM Supported: {TpmSupport}Hardware Policy: {HardwarePolicy}Exclude TPM 1.2: {IsTpm12Excluded}TPM Version: {TpmVersion}TPM FIPS: {IsTpmFIPS}TPM Locked Out: {IsTpmLockedOut}Satisfactory Key Pregeneration Pool: {IsKeyPregenPoolSatisfactory}Key Storage Provider: {KeyProvider}Result: {Result}
Microsoft-Windows-HelloForBusiness  |  5601      |           |
Microsoft-Windows-HelloForBusiness  |  5602      |           |
Microsoft-Windows-HelloForBusiness  |  6010      |           |  A key credential was unavailable for use by an app because it did not meet all the requirements for use. Key name: {KeyName}Reason: {KeyUseCredUnavailableReason}
Microsoft-Windows-HelloForBusiness  |  6045      |           |  Windows Hello processing stopped with warning {Error}. Processing time: {ProcessingTime} seconds
...
Microsoft-Windows-HelloForBusiness  |  7226      |           |  Windows Hello failed to delete the {KeyType} key.Key Name: {KeyName}Error: {Error}
...
Microsoft-Windows-HelloForBusiness  |  8510      |           |
