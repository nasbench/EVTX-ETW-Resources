...
Microsoft-Windows-Smartcard-Server  |  201       |           |  Failed to initialise Server Application:  {Message}
Microsoft-Windows-Smartcard-Server  |  202       |           |  Failed to initialise Server Application
...
Microsoft-Windows-Smartcard-Server  |  306       |           |  Command Despatch sees reader in invalid state
...
Microsoft-Windows-Smartcard-Server  |  502       |           |  Initialisation of Service Status Critical Section failed
...
Microsoft-Windows-Smartcard-Server  |  521       |           |  Smart Card Resource Manager received NULL handle from PnP event {Message}
...
Microsoft-Windows-Smartcard-Server  |  602       |           |  WDM Reader driver initialisation cannot open reader device:  {Reader}
Microsoft-Windows-Smartcard-Server  |  603       |           |  WDM Reader driver initialisation has no memory available to control device {Reader}
...
Microsoft-Windows-Smartcard-Server  |  611       |           |  Smart Card Reader initialisation failed
