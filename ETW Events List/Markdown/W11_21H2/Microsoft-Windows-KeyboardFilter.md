...
Microsoft-Windows-KeyboardFilter  |  10050     |  Microsoft-Windows-KeyboardFilter/Admin        |  Failed to attach session {Message} ({ErrorCode})
Microsoft-Windows-KeyboardFilter  |  10051     |  Microsoft-Windows-KeyboardFilter/Admin        |  Failed to detach session {Message} ({ErrorCode})
Microsoft-Windows-KeyboardFilter  |  10052     |  Microsoft-Windows-KeyboardFilter/Admin        |  Missing Breakout keycode
Microsoft-Windows-KeyboardFilter  |  10053     |  Microsoft-Windows-KeyboardFilter/Admin        |  IOCTLReadBreakoutKeyFailed {Message} ({ErrorCode})
Microsoft-Windows-KeyboardFilter  |  10054     |  Microsoft-Windows-KeyboardFilter/Admin        |  CreateResources failed {Message} ({ErrorCode})
Microsoft-Windows-KeyboardFilter  |  10055     |  Microsoft-Windows-KeyboardFilter/Admin        |  RPC initialization failed {Message} ({ErrorCode})
Microsoft-Windows-KeyboardFilter  |  10056     |  Microsoft-Windows-KeyboardFilter/Admin        |  BreakoutKey thread launch failure {Message} ({ErrorCode})
Microsoft-Windows-KeyboardFilter  |  10057     |  Microsoft-Windows-KeyboardFilter/Admin        |  Run failed while waiting on handles {Message} ({ErrorCode})
Microsoft-Windows-KeyboardFilter  |  10058     |  Microsoft-Windows-KeyboardFilter/Admin        |  Set KeyboardLayout failed {Message} ({ErrorCode})
Microsoft-Windows-KeyboardFilter  |  10059     |  Microsoft-Windows-KeyboardFilter/Admin        |  RegisterDeviceNotification failed {Message} ({ErrorCode})
