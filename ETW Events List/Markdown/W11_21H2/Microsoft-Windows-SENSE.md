...
Microsoft-Windows-SENSE  |  18        |  Microsoft-Windows-SENSE/Operational  |  OOBE (Windows Welcome) has completed.
...
Microsoft-Windows-SENSE  |  37        |  Microsoft-Windows-SENSE/Operational  |  Module: {module}, Quota: {{quotaValue}} {{quotaValueUnit}}, Percentage of quota utilisation: {percentageValue}.
...
Microsoft-Windows-SENSE  |  46        |  Microsoft-Windows-SENSE/Operational  |  Failed to register and start the event trace session [{TraceSessionName}] due to lack of resources. Error code: {HRESULT}. This is probably because there are too many active event trace sessions. The service will retry in one minute.
...
Microsoft-Windows-SENSE  |  72        |  Microsoft-Windows-SENSE/Operational  |  Tried to send the first full machine profile report. Result code: {HRESULT}
...
Microsoft-Windows-SENSE  |  86        |  Microsoft-Windows-SENSE/Operational  |  Starting again stopped the external service that should be up. Name: {ServiceName}, exit code: {ErrorCode}
...
Microsoft-Windows-SENSE  |  92        |  Microsoft-Windows-SENSE/Operational  |  Stopping sending sensor cyber data quota because the data quota is exceeded. Will resume sending once the quota period passes. State Mask: {UInt2}
...
Microsoft-Windows-SENSE  |  104       |  Microsoft-Windows-SENSE/Operational  |  Failed to queue asynchronous driver unload. Failure code: {HRESULT}
Microsoft-Windows-SENSE  |  105       |  Microsoft-Windows-SENSE/Operational  |  Failed to wait for driver unload.
...
Microsoft-Windows-SENSE  |  304       |  Microsoft-Windows-SENSE/Operational  |  Windows Defender Advanced Threat Protection Screenshot Audit user session log-on event for session id: {UInt1}, session name: {Message1}
...
Microsoft-Windows-SENSE  |  306       |  Microsoft-Windows-SENSE/Operational  |  Windows Defender Advanced Threat Protection Screenshot Audit user session unlock event for session id: {UInt1}
