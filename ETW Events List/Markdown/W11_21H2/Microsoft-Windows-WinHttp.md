...
Microsoft-Windows-WinHttp  |  801       |  Microsoft-Windows-WinHttp/Diagnostic   |  Client begins attempts to locate the WPAD configuration file: ConnectionName={ConnectionName}, DetectFlags={DetectFlags}
Microsoft-Windows-WinHttp  |  801       |  Microsoft-Windows-WinHttp/Diagnostic   |  Client begins attempts to locate the WPAD configuration file: ConnectionName={ConnectionName}, DetectFlags={DetectFlags}
Microsoft-Windows-WinHttp  |  802       |  Microsoft-Windows-WinHttp/Diagnostic   |  Begin search for configuration file using DHCP: Interface={Interface}
Microsoft-Windows-WinHttp  |  802       |  Microsoft-Windows-WinHttp/Diagnostic   |  Begin search for configuration file using DHCP: Interface={Interface}
Microsoft-Windows-WinHttp  |  803       |  Microsoft-Windows-WinHttp/Diagnostic   |  WPAD configuration file found using DHCP: Interface={Interface}, ConfigurationURL={ConfigurationURL}
Microsoft-Windows-WinHttp  |  803       |  Microsoft-Windows-WinHttp/Diagnostic   |  WPAD configuration file found using DHCP: Interface={Interface}, ConfigurationURL={ConfigurationURL}
Microsoft-Windows-WinHttp  |  804       |  Microsoft-Windows-WinHttp/Diagnostic   |  Search for WPAD configuration file using DHCP failed: Interface={Interface}, ConfigurationURL={ConfigurationURL}, Error={Error}
Microsoft-Windows-WinHttp  |  804       |  Microsoft-Windows-WinHttp/Diagnostic   |  Search for WPAD configuration file using DHCP failed: Interface={Interface}, ConfigurationURL={ConfigurationURL}, Error={Error}
Microsoft-Windows-WinHttp  |  805       |  Microsoft-Windows-WinHttp/Diagnostic   |  Begin search for configuration file using DNS: DetectFlags={DetectFlags}
Microsoft-Windows-WinHttp  |  806       |  Microsoft-Windows-WinHttp/Diagnostic   |  WPAD configuration file found using DNS: ConfigurationURL={ConfigurationURL}, DetectFlags={DetectFlags}
Microsoft-Windows-WinHttp  |  806       |  Microsoft-Windows-WinHttp/Diagnostic   |  WPAD configuration file found using DNS: ConfigurationURL={ConfigurationURL}, DetectFlags={DetectFlags}
Microsoft-Windows-WinHttp  |  807       |  Microsoft-Windows-WinHttp/Diagnostic   |  Search for WPAD configuration file using DNS failed: DetectFlags={DetectFlags}, Error={Error}
Microsoft-Windows-WinHttp  |  808       |  Microsoft-Windows-WinHttp/Diagnostic   |  Search for WPAD configruation file failed: Error={Error}
Microsoft-Windows-WinHttp  |  809       |  Microsoft-Windows-WinHttp/Diagnostic   |  Begin downloading the configuration file from the configuration URL: ConfigurationURL={ConfigurationURL}
Microsoft-Windows-WinHttp  |  809       |  Microsoft-Windows-WinHttp/Diagnostic   |  Begin downloading the configuration file from the configuration URL: ConfigurationURL={ConfigurationURL}
Microsoft-Windows-WinHttp  |  810       |  Microsoft-Windows-WinHttp/Diagnostic   |  Client successfully downloaded the configuration file from the configuration URL: ConfigurationURL={ConfigurationURL}
Microsoft-Windows-WinHttp  |  810       |  Microsoft-Windows-WinHttp/Diagnostic   |  Client successfully downloaded the configuration file from the configuration URL: ConfigurationURL={ConfigurationURL}
