...
Microsoft-Windows-USB-MAUSBHOST  |  113       |  This is the Analytic channel to which internal Analytic events from the MAUSB driver are sent.  |  Isochronous Out Transfer State Machine Exception
