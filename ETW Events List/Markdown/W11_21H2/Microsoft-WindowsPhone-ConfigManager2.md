...
---------------------------------------|------------|-----------|------------------------------------------------------------------------------------------------------------------------------
Microsoft-WindowsPhone-ConfigManager2  |  0         |           |
Microsoft-WindowsPhone-ConfigManager2  |  1         |           |  ICSPNode::Add: Parent: "{URI}", Child: "{URICHILD}", Options: {NodeOptions}, hr: ({Result})
Microsoft-WindowsPhone-ConfigManager2  |  2         |           |
Microsoft-WindowsPhone-ConfigManager2  |  3         |           |  ICSPNode::DeleteChild: Parent URI: "{URI1}", Child URI: "{URI2}", hr: ({Result})
Microsoft-WindowsPhone-ConfigManager2  |  4         |           |
Microsoft-WindowsPhone-ConfigManager2  |  5         |           |  ICSPNode::Clear: this URI: "{StringOne}", hr: ({Result})
Microsoft-WindowsPhone-ConfigManager2  |  6         |           |
Microsoft-WindowsPhone-ConfigManager2  |  7         |           |  ICSPNode::SetValue: URI: "{StringOne}", hr: ({Result})
Microsoft-WindowsPhone-ConfigManager2  |  8         |           |
Microsoft-WindowsPhone-ConfigManager2  |  9         |           |  ICSPNode::GetProperty: GUID: {Property}, Value: {Value}, hr: ({Result})
Microsoft-WindowsPhone-ConfigManager2  |  10        |           |
Microsoft-WindowsPhone-ConfigManager2  |  11        |           |  ICSPNode::SetProperty: GUID: {Property}, hr: ({Result})
Microsoft-WindowsPhone-ConfigManager2  |  12        |           |
Microsoft-WindowsPhone-ConfigManager2  |  13        |           |  ICSPNode::Copy: URI: "{URI}", Options: {NodeOptions}, hr: ({Result})
Microsoft-WindowsPhone-ConfigManager2  |  14        |           |
Microsoft-WindowsPhone-ConfigManager2  |  15        |           |  ICSPNode::Execute: hr: ({Result})
Microsoft-WindowsPhone-ConfigManager2  |  16        |           |
Microsoft-WindowsPhone-ConfigManager2  |  17        |           |  ICSPNode::Move: target URI: "{StringOne}", hr: ({Result})
Microsoft-WindowsPhone-ConfigManager2  |  18        |           |
Microsoft-WindowsPhone-ConfigManager2  |  19        |           |  ICSPNode::GetValue: URI: "{StringOne}", hr: ({Result})
Microsoft-WindowsPhone-ConfigManager2  |  20        |           |
Microsoft-WindowsPhone-ConfigManager2  |  21        |           |  ICSPNode::DeleteProperty: GUID: {Guid}, hr: ({Result})
Microsoft-WindowsPhone-ConfigManager2  |  22        |           |
Microsoft-WindowsPhone-ConfigManager2  |  23        |           |  ICSPNode::GetPropertyIdentifiers: Count: {PropCount}, hr: ({Result})
Microsoft-WindowsPhone-ConfigManager2  |  24        |           |
Microsoft-WindowsPhone-ConfigManager2  |  25        |           |  ICSPNode::GetChildNodeNames: Count: {ChildCount}, hr: ({Result})
Microsoft-WindowsPhone-ConfigManager2  |  26        |           |  Cmd::PersistRollback: CmdType: {CmdType}, hr: ({Result})
Microsoft-WindowsPhone-ConfigManager2  |  27        |           |  Cmd::Execute: CmdType: {CmdType}, hr: ({Result})
Microsoft-WindowsPhone-ConfigManager2  |  28        |           |  Cmd::Rollback: CmdType: {CmdType}, IsRecovery: {IsRecovery}, hr: ({Result})
Microsoft-WindowsPhone-ConfigManager2  |  29        |           |  LaunchRecoveryRollback exception: {Result}
Microsoft-WindowsPhone-ConfigManager2  |  30        |           |  ConfigManager2::PrepareRollbackFile: hr: ({Result})
Microsoft-WindowsPhone-ConfigManager2  |  31        |           |  ConfigManager2::ClearRecoveryRollbackState: hr: ({Result})
Microsoft-WindowsPhone-ConfigManager2  |  32        |           |  FinishProvisioningTransaction: exception: {Result}
Microsoft-WindowsPhone-ConfigManager2  |  50        |           |  IConfigServiceProvicer2::GetNode: URI: "{URI}", Options: {NodeOptions}, hr: ({Result})
Microsoft-WindowsPhone-ConfigManager2  |  51        |           |  IConfigServiceProvider2::ConfigManagerNotification: notification: {Notification}, hr: ({Result})
Microsoft-WindowsPhone-ConfigManager2  |  52        |           |
Microsoft-WindowsPhone-ConfigManager2  |  53        |           |
Microsoft-WindowsPhone-ConfigManager2  |  54        |           |  ICSPNodeTransactioning::PersistRollbackAddState: hr: ({Result})
Microsoft-WindowsPhone-ConfigManager2  |  55        |           |
...
Microsoft-WindowsPhone-ConfigManager2  |  98        |           |  CNodeWrapper::ExternalRollbackDeleteChild: hr: ({Result})
...
Microsoft-WindowsPhone-ConfigManager2  |  136       |           |  ICSPNode::GetValue: URI: "{StringOne}", hr: ({Result})
...
Microsoft-WindowsPhone-ConfigManager2  |  168       |           |  CNodeWrapper::ExternalRollbackMove: hr ({Result})
...
Microsoft-WindowsPhone-ConfigManager2  |  203       |           |  CmLockSvcInit Service startup failure detected, Current state ({hr1}), Exit code ({hr2}), Service Specific Exit code ({hr3})
