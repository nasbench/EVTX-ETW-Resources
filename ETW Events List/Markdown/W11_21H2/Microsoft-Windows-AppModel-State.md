...
----------------------------------|------------|-----------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------
Microsoft-Windows-AppModel-State  |  1         |  Microsoft-Windows-AppModel-State/Debug       |  Error while deleting file: {ErrorString}. Error Code: {Error}
Microsoft-Windows-AppModel-State  |  2         |  Microsoft-Windows-AppModel-State/Debug       |  Error while deleting directory: {ErrorString}. Error Code: {Error}
Microsoft-Windows-AppModel-State  |  3         |  Microsoft-Windows-AppModel-State/Debug       |
Microsoft-Windows-AppModel-State  |  4         |  Microsoft-Windows-AppModel-State/Debug       |  ApiSet Function: {ErrorString} returned with Error Code: {Error}
Microsoft-Windows-AppModel-State  |  5         |  Microsoft-Windows-AppModel-State/Debug       |  Low-level data store access error. Function: {ErrorString} returned with Error Code: {Error}
Microsoft-Windows-AppModel-State  |  6         |  Microsoft-Windows-AppModel-State/Debug       |
Microsoft-Windows-AppModel-State  |  7         |  Microsoft-Windows-AppModel-State/Debug       |
Microsoft-Windows-AppModel-State  |  8         |  Microsoft-Windows-AppModel-State/Debug       |  Cleanup of temporary state was unable to enumerate the user profiles.  Object: {ErrorString}, Error Code: {Error}.
Microsoft-Windows-AppModel-State  |  9         |  Microsoft-Windows-AppModel-State/Debug       |
Microsoft-Windows-AppModel-State  |  10        |  Application                                  |  Failure to load the application settings for package {ErrorString}. Error Code: {Error}
Microsoft-Windows-AppModel-State  |  11        |  Application                                  |  Failure to read an application setting for package {ErrorString}. Error Code: {Error}
Microsoft-Windows-AppModel-State  |  12        |  Application                                  |  Failure to write an application setting for package {ErrorString}. Error Code: {Error}
Microsoft-Windows-AppModel-State  |  13        |  Application                                  |  Failure to instantiate storage folder {FolderString} for package {PackageString} with Error Code: {Error}
Microsoft-Windows-AppModel-State  |  14        |  Microsoft-Windows-AppModel-State/Debug       |  Need to update state locations of package {PackageString} for user {UserSid} because the schema is not found. Error Code: {Error}
Microsoft-Windows-AppModel-State  |  15        |  Microsoft-Windows-AppModel-State/Debug       |  Need to update state locations of package {PackageString} for user {UserSid} because the package is not found. Error Code: {Error}
Microsoft-Windows-AppModel-State  |  16        |  Microsoft-Windows-AppModel-State/Debug       |  Need to update state locations of package {PackageString} for user {UserSid} because the package full name has changed. Error Code: {Error}
Microsoft-Windows-AppModel-State  |  17        |  Microsoft-Windows-AppModel-State/Debug       |  Need to update state locations of package {PackageString} for user {UserSid} because the schema version has changed. Error Code: {Error}
Microsoft-Windows-AppModel-State  |  18        |  Microsoft-Windows-AppModel-State/Debug       |  Succeeded to fix state locations for package {InformationalString}.
Microsoft-Windows-AppModel-State  |  19        |  Microsoft-Windows-AppModel-State/Debug       |  Failure to fix state locations for package {ErrorString}. Error Code: {Error}
Microsoft-Windows-AppModel-State  |  20        |  Application                                  |  Triggered repair because operation {Operation} against package {PackageFamily} hit error {OperationError}.
Microsoft-Windows-AppModel-State  |  21        |  Application                                  |  Repair for operation {Operation} against package {PackageFamily} with error {OperationError} returned Error Code: {RepairTriggerError}
Microsoft-Windows-AppModel-State  |  22        |  Application                                  |  Folder path {FolderPath} failed access check: Error Code: {Error}
Microsoft-Windows-AppModel-State  |  23        |  Application                                  |  Triggered repair of state locations because operation {Operation} against package {PackageFamily} hit error {OperationError}.
Microsoft-Windows-AppModel-State  |  24        |  Application                                  |  Repair of state locations for operation {Operation} against package {PackageFamily} with error {OperationError} returned Error Code: {RepairTriggerError}
Microsoft-Windows-AppModel-State  |  50        |  Microsoft-Windows-AppModel-State/Diagnostic  |
Microsoft-Windows-AppModel-State  |  51        |  Microsoft-Windows-AppModel-State/Diagnostic  |
Microsoft-Windows-AppModel-State  |  60        |  Microsoft-Windows-AppModel-State/Diagnostic  |
Microsoft-Windows-AppModel-State  |  61        |  Microsoft-Windows-AppModel-State/Diagnostic  |
Microsoft-Windows-AppModel-State  |  70        |  Microsoft-Windows-AppModel-State/Diagnostic  |
Microsoft-Windows-AppModel-State  |  71        |  Microsoft-Windows-AppModel-State/Diagnostic  |
