...
-----------------------------------|------------|----------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Microsoft-Windows-WWAN-SVC-EVENTS  |  1001      |  WWAN Diagnostic Channel   |  WWAN Service event: [Error] {FunctionCall}: {Message}
Microsoft-Windows-WWAN-SVC-EVENTS  |  1002      |  WWAN Diagnostic Channel   |  WWAN Service event: [Warning] {FunctionCall}: {Message}
Microsoft-Windows-WWAN-SVC-EVENTS  |  1003      |  WWAN Diagnostic Channel   |  {FunctionCall} Failed with Error Code {ErrorCode} in {Method}
Microsoft-Windows-WWAN-SVC-EVENTS  |  1004      |  WWAN Diagnostic Channel   |  WWAN Service event: [Info] {FunctionCall}: {Message}
Microsoft-Windows-WWAN-SVC-EVENTS  |  1005      |  WWAN Diagnostic Channel   |  WWAN Service event: [Verbose] {FunctionCall}: {Message}
Microsoft-Windows-WWAN-SVC-EVENTS  |  1006      |  WWAN Diagnostic Channel   |  WWAN Service event: [Error] {FunctionCall}: {Message} Interface: {{InterfaceGuid}}
Microsoft-Windows-WWAN-SVC-EVENTS  |  1007      |  WWAN Diagnostic Channel   |  WWAN Service event: [Warning] {FunctionCall}: {Message} Interface: {{InterfaceGuid}}
Microsoft-Windows-WWAN-SVC-EVENTS  |  1008      |  WWAN Diagnostic Channel   |  WWAN Service event: [Info] {FunctionCall}: {Message} Interface: {{InterfaceGuid}}
Microsoft-Windows-WWAN-SVC-EVENTS  |  1009      |  WWAN Diagnostic Channel   |  WWAN Service event: [Verbose] {FunctionCall}: {Message} Interface: {{InterfaceGuid}}
Microsoft-Windows-WWAN-SVC-EVENTS  |  1010      |  WWAN Diagnostic Channel   |  [FallbackError] {message}, wilFailureType:{wilFailureType}, hresult:{hresult}
...
Microsoft-Windows-WWAN-SVC-EVENTS  |  2100      |  WWAN Diagnostic Channel   |
Microsoft-Windows-WWAN-SVC-EVENTS  |  2101      |  WWAN Diagnostic Channel   |  WWAN Service event: Error({ErrorCode}) occurs during Interface(Device) enumeration
Microsoft-Windows-WWAN-SVC-EVENTS  |  2102      |  WWAN Diagnostic Channel   |  WWAN Service event: Interface is added to WwanManager successfully
Microsoft-Windows-WWAN-SVC-EVENTS  |  2103      |  WWAN Diagnostic Channel   |  [M:{ModemIndex}][E:{ExecutorIndex}] Modem Object (Type {ModemType}) created
Microsoft-Windows-WWAN-SVC-EVENTS  |  2104      |  WWAN Diagnostic Channel   |  [M:{ModemIndex}][E:{ExecutorIndex}] Modem Object (Type {ModemType}) creation failed
Microsoft-Windows-WWAN-SVC-EVENTS  |  2105      |  WWAN Diagnostic Channel   |  [M:{ModemIndex}][E:{ExecutorIndex}] New Executor Object is added to the modem (guid:{ModemGuid})
Microsoft-Windows-WWAN-SVC-EVENTS  |  2106      |  WWAN Diagnostic Channel   |  [M:{ModemIndex}][E:{ExecutorIndex}] Removed Executor Object from the modem (guid:{ModemGuid})
Microsoft-Windows-WWAN-SVC-EVENTS  |  2107      |  WWAN Diagnostic Channel   |  [M:{ModemIndex}][E:{ExecutorIndex}] Interface support SysCaps? ({IsSysCapsSupport})
Microsoft-Windows-WWAN-SVC-EVENTS  |  2108      |  WWAN Diagnostic Channel   |  [M:{ModemIndex}][E:{ExecutorIndex}] Updated interface with receivced {CapsType}
...
Microsoft-Windows-WWAN-SVC-EVENTS  |  11022     |  WWAN Operational Channel  |  [Request={RequestId}] Received DeviceCapsEx, status={WwanStatus}, DeviceType={DeviceType}, CellularClass={CellularClass}, VoiceClass={VoiceClass}, SimClass={SimClass}, DataClass={DataClass}, CustomDataClass={CustomDataClass}, BandClass={InterfaceGuid}0, CustomBandClass={InterfaceGuid}1, SmsCaps={InterfaceGuid}2, CtrlCaps={InterfaceGuid}3, IMEI={InterfaceGuid}4, Mfg={InterfaceGuid}5, Model={InterfaceGuid}6, Fw={InterfaceGuid}7, MaxActvdCtxts={InterfaceGuid}8, AuthAlgoCaps={InterfaceGuid}9, ExecId={RequestId}0, SO={RequestId}1, miniport={InterfaceGuid}
...
Microsoft-Windows-WWAN-SVC-EVENTS  |  12254     |  WWAN Diagnostic Channel   |  ICCID [{IccID}] Name [{profileName}] connnection mode: {connMode} isadditional {isAdditionalPdpContextProfile} creation type {profileSource}
Microsoft-Windows-WWAN-SVC-EVENTS  |  12255     |  WWAN Diagnostic Channel   |  ICCID [{IccID}] Name [{ProfileName}]
Microsoft-Windows-WWAN-SVC-EVENTS  |  12256     |  WWAN Diagnostic Channel   |  ICCID [{IccID}] Name [{ProfileName}]
