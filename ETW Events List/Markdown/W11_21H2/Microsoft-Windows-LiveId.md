...
--------------------------|------------|-----------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Microsoft-Windows-LiveId  |  1005      |           |
Microsoft-Windows-LiveId  |  1006      |           |  ConnectIdentity_Stop.Status: {Result}
Microsoft-Windows-LiveId  |  1007      |           |
Microsoft-Windows-LiveId  |  1008      |           |  DisconnectIdentity_Stop.Status: {Result}
Microsoft-Windows-LiveId  |  1013      |           |
Microsoft-Windows-LiveId  |  1014      |           |  NetworkCall_Stop.Number of Targets: {NoOfTargets}RequestType: {RequestType}
Microsoft-Windows-LiveId  |  1015      |           |
Microsoft-Windows-LiveId  |  1016      |           |  DeviceAuth_Stop.Status: {TicketsCached}
Microsoft-Windows-LiveId  |  1017      |           |
Microsoft-Windows-LiveId  |  1018      |           |  UserAuth_Stop.Status: {TicketsCached}
Microsoft-Windows-LiveId  |  1019      |           |
Microsoft-Windows-LiveId  |  1020      |           |  PromptForCredentials_Stop.Status: {Result}
Microsoft-Windows-LiveId  |  1021      |           |  SignOutUser_RegistryOpenOrReadFailure. RegistryLocation: {RegistryLocation}. Status: {Status}
Microsoft-Windows-LiveId  |  1022      |           |  SignOutUser_RegistryWriteFailure. RegistryLocation: {RegistryLocation}. Status: {Status}
Microsoft-Windows-LiveId  |  2008      |           |
Microsoft-Windows-LiveId  |  2009      |           |
Microsoft-Windows-LiveId  |  2010      |           |
Microsoft-Windows-LiveId  |  2011      |           |
Microsoft-Windows-LiveId  |  2012      |           |
Microsoft-Windows-LiveId  |  2013      |           |
Microsoft-Windows-LiveId  |  2014      |           |
Microsoft-Windows-LiveId  |  2015      |           |
Microsoft-Windows-LiveId  |  2016      |           |  CommandLinkClicked_Stop.Status: {Result}
Microsoft-Windows-LiveId  |  2017      |           |
Microsoft-Windows-LiveId  |  2018      |           |  UserImageGetBitmapValue_Stop.Status: {Result}
Microsoft-Windows-LiveId  |  2019      |           |
Microsoft-Windows-LiveId  |  2020      |           |  CredProvSetSerialization_Stop.Status: {Result}
Microsoft-Windows-LiveId  |  2021      |           |
Microsoft-Windows-LiveId  |  2022      |           |  CredProvGetSerialization_Stop.Status: {Result}
Microsoft-Windows-LiveId  |  2023      |           |  Operation: {Operation}Details: {Target}Status: {Result}
Microsoft-Windows-LiveId  |  2024      |           |  Operation: {Operation}Details: {Details}Status: {Status}
Microsoft-Windows-LiveId  |  2025      |           |  WLIDSvc service failed to start.Function: {Operation}Reason: {Reason}Status: {Result}
Microsoft-Windows-LiveId  |  2026      |           |  Generic telemetry trigger event.PointType: {PointType}AppName: {AppName}ModuleName: {ModuleName}ModuleVersion: {ModuleVersion}FileName: {FileName}FunctionName: {FunctionName}LineNumber: {LineNumber}ErrorCode: {ErrorCode}
Microsoft-Windows-LiveId  |  2027      |           |  User-specific telemetry trigger event for CID {cid}.
Microsoft-Windows-LiveId  |  2028      |           |  ErrorVerifier in function {FunctionName} encountered unexpected error code ({ErrorCode}).
