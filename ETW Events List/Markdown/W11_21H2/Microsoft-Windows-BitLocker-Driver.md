...
Microsoft-Windows-BitLocker-Driver  |  24687     |  System   |  BitLocker timed out attempting to enumerate bands during volume discovery on this hardware encrypting drive.
Microsoft-Windows-BitLocker-Driver  |  24688     |  System   |  Failed to read metadata from logical copy. Volume: {Volume}, Start Offset: {Offset}, Read Length: {Length}, Copy: {Copy}, Number of Copies:{TotalCopies}
Microsoft-Windows-BitLocker-Driver  |  24689     |  System   |  Attempted to read metadata from logical copy. Volume: {Volume}, Start Offset: {Offset}, Read Length: {Length}, Copy: {Copy}, Number of Copies:{TotalCopies}
Microsoft-Windows-BitLocker-Driver  |  24690     |  System   |  Attempted to fix metadata logical copies. Volume: {Volume}, ManageFlags: {WritePhase}
Microsoft-Windows-BitLocker-Driver  |  24691     |  System   |  Failed to verify metadata logical copy against Primary. Volume: {Volume}, Start Offset: {Offset}, Read Length: {Length}, Copy: {Copy}, Number of Copies:{TotalCopies}
Microsoft-Windows-BitLocker-Driver  |  24692     |  System   |  Failed to verify metadata file against Primary copy. Volume: {Volume}, Start Offset: {Offset}, Read Length: {Length}, Copy: {Copy}, Number of Copies:{TotalCopies}
Microsoft-Windows-BitLocker-Driver  |  24693     |  System   |  Failed to register metadata check worker. Volume: {Volume}
Microsoft-Windows-BitLocker-Driver  |  24694     |  System   |  Metadata check worker started. Volume: {Volume}
Microsoft-Windows-BitLocker-Driver  |  24695     |  System   |  Metadata check worker completed. Volume: {Volume}
Microsoft-Windows-BitLocker-Driver  |  24696     |  System   |  Successfully created metadata file. Volume: {Volume}, Offset: {Offset}, Read Length: {Length}, Copy: {Copy}, Number of Copies: {TotalCopies}, TpAllocationSize: {SlabSize}
Microsoft-Windows-BitLocker-Driver  |  24697     |  System   |  Failed to read a valid metadata copy. Volume: {Volume}, Start Offset: {Offset}, Index: {Copy}
Microsoft-Windows-BitLocker-Driver  |  24698     |  System   |  Failed to fix metadata logical copy. Volume: {Volume}, Start Offset: {Offset},  Read Length: {Length}, Source Index: {Copy}, Number of Copies: {TotalCopies}, TpAllocationSize: {SlabSize}
Microsoft-Windows-BitLocker-Driver  |  24699     |  System   |  Attempted to check metadata logical copies. Volume: {Volume}, ManageFlags: {WritePhase}
Microsoft-Windows-BitLocker-Driver  |  24700     |  System   |  Successfully fixed metadata logical copy. Volume: {Volume}, Start Offset: {Offset},  Read Length: {Length}, Source Index: {Copy}, Number of Copies: {TotalCopies}, TpAllocationSize: {SlabSize}