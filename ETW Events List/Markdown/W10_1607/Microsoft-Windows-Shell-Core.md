...
Microsoft-Windows-Shell-Core  |  62442     |  Microsoft-Windows-Shell-Core/AppDefaults        |  Upraded to prog id {ProgId} from prog id {CurrentDefaultProgId} for {ExtOrUriScheme}
