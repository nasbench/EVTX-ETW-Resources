...
Microsoft-Windows-AppXDeployment-Server  |  751       |  Microsoft-Windows-AppXDeploymentServer/Operational  |  Windows failed to undo changes to package {PackageName}. The package needs to be reinstalled.
