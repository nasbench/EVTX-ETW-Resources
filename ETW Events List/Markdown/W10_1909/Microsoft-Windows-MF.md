...
Microsoft-Windows-MF  |  1147      |  Media Foundation AsyncWrapper       |  ProcessInput Expand Sample - Object ({WrapperPtr}) Stream ID ({StreamID}) Buffer Index ({Buffer Index}) Time ({Timestamp}) Duration ({Duration})
