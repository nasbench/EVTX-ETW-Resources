...
Microsoft-Windows-AppXDeployment-Server  |  779       |  Microsoft-Windows-AppXDeploymentServer/Operational  |  Windows cannot install non-preinstalled package {PackageName} to volume {Path} because the volume is the Preinstalled Apps volume.
Microsoft-Windows-AppXDeployment-Server  |  780       |  Microsoft-Windows-AppXDeploymentServer/Operational  |  Windows cannot move package {PackageName} from volume {Path} because the volume is the Preinstalled Apps volume.
Microsoft-Windows-AppXDeployment-Server  |  781       |  Microsoft-Windows-AppXDeploymentServer/Operational  |  Windows cannot move package {PackageName} to volume {Path} because the volume is the Preinstalled Apps volume.
...
Microsoft-Windows-AppXDeployment-Server  |  783       |  Microsoft-Windows-AppXDeploymentServer/Operational  |  Windows cannot remove package {PackageName} from volume {Path} because the volume is the Preinstalled Apps volume.
...
Microsoft-Windows-AppXDeployment-Server  |  8107      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  Illegal non-AppStore package integrity validation attempted for package {PackageFullName}. Flags: {Flags}
...
Microsoft-Windows-AppXDeployment-Server  |  8200      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  Successfully added volume {VolumeKey} with name "{VolumeName}" and mountPoint "{VolumeMountPoint}".
Microsoft-Windows-AppXDeployment-Server  |  8201      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  Successfully set volume {VolumeKey} with name "{VolumeName}" and mountPoint "{VolumeMountPoint}" offline.
Microsoft-Windows-AppXDeployment-Server  |  8202      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  Successfully set volume {VolumeKey} with name "{VolumeName}" and mountPoint "{VolumeMountPoint}" online.
Microsoft-Windows-AppXDeployment-Server  |  8203      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  Successfully removed volume {VolumeKey} with name "{VolumeName}" and mountPoint "{VolumeMountPoint}".
Microsoft-Windows-AppXDeployment-Server  |  8205      |  Microsoft-Windows-AppXDeploymentServer/Operational  |  {ErrorCode}: Found a corrupt volume {VolumeKey} with name "{VolumeName}" and mountPoint "{VolumeMountPoint}".
