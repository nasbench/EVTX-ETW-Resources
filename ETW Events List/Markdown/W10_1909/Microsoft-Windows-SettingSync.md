...
-------------------------------|------------|----------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Microsoft-Windows-SettingSync  |  5001      |  Microsoft-Windows-SettingSync/Operational   |  Local create for collection {CollectionId} failed. (Result: {HRESULT})
Microsoft-Windows-SettingSync  |  5002      |  Microsoft-Windows-SettingSync/Operational   |  Remote create for collection {CollectionId} failed. (Result: {HRESULT})
Microsoft-Windows-SettingSync  |  5003      |  Microsoft-Windows-SettingSync/Operational   |  Download for collection {CollectionId} failed. (Result: {HRESULT})
Microsoft-Windows-SettingSync  |  5004      |  Microsoft-Windows-SettingSync/Operational   |  Upload for collection {CollectionId} failed. (Result: {HRESULT})
Microsoft-Windows-SettingSync  |  5005      |  Microsoft-Windows-SettingSync/Operational   |  Local delete for collection {CollectionId} failed. (Result: {HRESULT})
Microsoft-Windows-SettingSync  |  5006      |  Microsoft-Windows-SettingSync/Operational   |  Remote delete for collection {CollectionId} failed. (Result: {HRESULT})
Microsoft-Windows-SettingSync  |  5007      |  Microsoft-Windows-SettingSync/Operational   |  Applying setting unit {SettingUnitId} for collection {CollectionId} failed. (Result: {HRESULT})
Microsoft-Windows-SettingSync  |  5008      |  Microsoft-Windows-SettingSync/Operational   |  Removing setting unit {SettingUnitId} for collection {CollectionId} failed. (Result: {HRESULT})
Microsoft-Windows-SettingSync  |  5009      |  Microsoft-Windows-SettingSync/Operational   |  Resolving a conflict with setting unit {SettingUnitId} for collection {CollectionId} with sync operation {Operation} failed (Result: {HRESULT}).
Microsoft-Windows-SettingSync  |  5010      |  Microsoft-Windows-SettingSync/Operational   |  Merging setting unit {SettingUnitId} for collection {CollectionId} with sync operation {Operation} failed (Result: {HRESULT}).
Microsoft-Windows-SettingSync  |  5011      |  Microsoft-Windows-SettingSync/Operational   |  The system failed to request a sync for collection {CollectionId} (operation: {Operation}, Result: {HRESULT}).
Microsoft-Windows-SettingSync  |  5012      |  Microsoft-Windows-SettingSync/Operational   |  The sync at logon failed (Result {HRESULT}).
Microsoft-Windows-SettingSync  |  5013      |  Microsoft-Windows-SettingSync/Operational   |  Failed to flush delayed uploads (Result: {HRESULT})
Microsoft-Windows-SettingSync  |  5014      |  Microsoft-Windows-SettingSync/Operational   |  The setting unit {SettingUnitId} for collection {CollectionId} is invalid. (operation: {Operation}, Result: {HRESULT}).
Microsoft-Windows-SettingSync  |  5015      |  Microsoft-Windows-SettingSync/Operational   |  Profile notification handler will not sync at logon. (Reason: {Value})
Microsoft-Windows-SettingSync  |  5016      |  Microsoft-Windows-SettingSync/Operational   |  Restoring operations failed (Result: {HRESULT}).
Microsoft-Windows-SettingSync  |  5017      |  Microsoft-Windows-SettingSync/Operational   |  The connect/disconnect ({Value}) operation failed (Result: {HRESULT}).
Microsoft-Windows-SettingSync  |  5018      |  Microsoft-Windows-SettingSync/Operational   |  The host process failed to initialize (Result: {HRESULT}).
Microsoft-Windows-SettingSync  |  5019      |  Microsoft-Windows-SettingSync/Operational   |  Failed to scan collection {CollectionId} for offline changes. (Result: {HRESULT}).
Microsoft-Windows-SettingSync  |  5020      |  Microsoft-Windows-SettingSync/Operational   |  Starting or stopping setting change publisher for {CollectionId} failed. (Result: {HRESULT})
Microsoft-Windows-SettingSync  |  5021      |  Microsoft-Windows-SettingSync/Operational   |  Ending the sync batch failed. (Result: {HRESULT})
Microsoft-Windows-SettingSync  |  5022      |  Microsoft-Windows-SettingSync/Operational   |  The PDC task request failed (Result: {HRESULT}).
Microsoft-Windows-SettingSync  |  5023      |  Microsoft-Windows-SettingSync/Operational   |  Failed to schedule end sync batch (Result: {HRESULT}).
Microsoft-Windows-SettingSync  |  5024      |  Microsoft-Windows-SettingSync/Operational   |  Failed to create process {CollectionId} (Result: {HRESULT}).
Microsoft-Windows-SettingSync  |  5025      |  Microsoft-Windows-SettingSync/Operational   |  Scheduling backup for collection {CollectionId} failed. (Result: {HRESULT})
Microsoft-Windows-SettingSync  |  5026      |  Microsoft-Windows-SettingSync/Operational   |  Scheduling restore for collection {CollectionId} failed. (Result: {HRESULT})
Microsoft-Windows-SettingSync  |  5027      |  Microsoft-Windows-SettingSync/Operational   |  Moving items from roaming to backup replica for collection {CollectionId} failed. (Result: {HRESULT})
Microsoft-Windows-SettingSync  |  5028      |  Microsoft-Windows-SettingSync/Operational   |  Moving items from backup to roaming replica for collection {CollectionId} failed. (Result: {HRESULT})
...
Microsoft-Windows-SettingSync  |  5726      |  Microsoft-Windows-SettingSync/Operational   |  Bootstrap remote metadata failed for {CollectionId} HRESULT: {HRESULT}.
