...
Microsoft-Windows-UserDataAccess-UnifiedStore  |  50        |           |  Info: {P1_HResult} Location: {P2_String} Line Number: {P3_UInt32}
...
Microsoft-Windows-UserDataAccess-UnifiedStore  |  2001      |           |  Terminated suspended app [{Prop_INT}]: result [{Prop_Handle}]
Microsoft-Windows-UserDataAccess-UnifiedStore  |  2002      |           |  App lost change tracking [{Arg1}]: current rev [{Arg2}], deleted item rev [{Arg3}]
