...
Microsoft-Windows-Hyper-V-VID  |  5002      |  Microsoft-Windows-Hyper-V-VID-Analytic  |  Finished reserving pages with status = {Parameter2}. {Parameter1} pages reserved. {Parameter3} LargeLocal, {Parameter4} SmallLocal, {Parameter5} LargeRemote, {Parameter6} SmallRemote. (Partition ID {Parameter0})
