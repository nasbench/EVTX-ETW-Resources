...
Microsoft-Windows-Eventlog  |  27        |  System    |  The event logging service encountered an error (res={ErrorCode}) while opening log file for channel {ChannelPath} at {FailedLogFilePath}. Trying again using default log file path {NewLogFilePath}.
